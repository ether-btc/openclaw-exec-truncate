...
import { o as resolveDmGroupAccessWithLists } from "./dm-policy-shared-CXuIpNws.js";
...
import { a as createWebhookInFlightLimiter, s as readJsonWebhookBodyOrReject } from "./webhook-request-guards-Bpgg51GB.js";
import { n as resolveWebhookPath } from "./webhook-path-DlK3D1Pt.js";
import { l as withResolvedWebhookRequestPipeline, n as registerWebhookTargetWithPluginRoute, o as resolveWebhookTargetWithAuthOrReject } from "./webhook-targets-B-UXFx3k.js";
...
import { c as sendGoogleChatMessage, d as verifyGoogleChatRequest, i as downloadGoogleChatMedia, l as updateGoogleChatMessage, n as deleteGoogleChatMessage, s as probeGoogleChat, u as uploadGoogleChatAttachment } from "./api-CA5EPa_P.js";
...
function warnDeprecatedUsersEmailEntries(logVerbose, entries) {
	...
	const key = deprecated.map((v) => normalizeLowercaseStringOrEmpty(v)).toSorted().join(",");
...
function warnMutableGroupKeysConfigured(logVerbose, groups) {
	...
	const warningKey = mutableKeys.map((key) => normalizeLowercaseStringOrEmpty(key)).toSorted().join(",");
...
async function uploadAttachmentForReply(params) {
	...
	const { uploadGoogleChatAttachment } = await import("./api-C5xvFgGk.js");
