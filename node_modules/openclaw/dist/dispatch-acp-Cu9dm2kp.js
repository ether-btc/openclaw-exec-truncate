...
import { s as hasOutboundReplyContent } from "./reply-payload-BRozqdR-.js";
import { n as formatToolSummary, r as resolveToolDisplay } from "./tool-display-C3y9QnJi.js";
import { i as emitAgentEvent } from "./agent-events-D0ACUj3I.js";
import { i as toAcpRuntimeError } from "./errors-DASGJrYh.js";
import { o as isSessionIdentityPending, u as resolveSessionIdentityFromMeta } from "./session-identity-BrSX0TPG.js";
import { n as resolveAcpAgentPolicyError, r as resolveAcpDispatchPolicyError } from "./policy-6zBTSZPU.js";
import { r as resolveAcpThreadSessionDetailLines } from "./session-identifiers-qkbF5HDz.js";
import { r as prefixSystemMessage } from "./system-message-BQz8DGb0.js";
...
import { r as resolveEffectiveBlockStreamingConfig, t as clampPositiveInteger } from "./block-streaming-BlHwKPvB.js";
import { t as formatAcpRuntimeErrorText } from "./error-text-EsUvBPSI.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-DN5ef40U.js";
import { r as createBlockReplyPipeline } from "./block-reply-pipeline-CjCkmQ4a.js";
...
function loadDispatchAcpMediaRuntime() {
	dispatchAcpMediaRuntimePromise ??= import("./dispatch-acp-media.runtime-BrEQRUS0.js");
...
function loadDispatchAcpTtsRuntime$1() {
	dispatchAcpTtsRuntimePromise$1 ??= import("./dispatch-acp-tts.runtime-05sHw2pM.js");
	return dispatchAcpTtsRuntimePromise$1;
}
function loadChannelPluginRuntime() {
	channelPluginRuntimePromise ??= import("./plugins-CHdWE64I.js");
	return channelPluginRuntimePromise;
}
function loadMessageActionRuntime() {
	messageActionRuntimePromise ??= import("./message-action-runner-CBkLAkzS.js");
...
function loadDispatchAcpManagerRuntime() {
	dispatchAcpManagerRuntimePromise ??= import("./dispatch-acp-manager.runtime-B_3H8O8U.js");
	return dispatchAcpManagerRuntimePromise;
}
function loadDispatchAcpSessionRuntime() {
	dispatchAcpSessionRuntimePromise ??= import("./dispatch-acp-session.runtime-D33pc5cl.js");
	return dispatchAcpSessionRuntimePromise;
}
function loadDispatchAcpTtsRuntime() {
	dispatchAcpTtsRuntimePromise ??= import("./dispatch-acp-tts.runtime-05sHw2pM.js");
