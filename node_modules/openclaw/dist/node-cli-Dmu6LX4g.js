...
import { o as sameFileIdentity } from "./boundary-file-read-D4i4p3X_.js";
...
import { r as theme, t as colorize } from "./theme-DZuqFJmv.js";
import { n as VERSION } from "./version-UAlvKBGq.js";
import { i as resolveAgentConfig } from "./agent-scope-CYaif3uh.js";
import { a as logWarn } from "./logger-CBoRj7CR.js";
import { c as loadConfig } from "./config-DMMR1XE_.js";
import { f as NODE_EXEC_APPROVALS_COMMANDS, m as NODE_SYSTEM_RUN_COMMANDS } from "./loader-CVkGO8jl.js";
import { c as sanitizeSystemRunEnvOverrides, o as sanitizeHostExecEnv, t as inspectHostExecEnvOverrides } from "./host-env-security-DdUy_DwF.js";
import { A as POSIX_INLINE_COMMAND_FLAGS, F as unwrapKnownDispatchWrapperInvocation, I as normalizeExecutableToken, M as resolveInlineCommandMatch, O as resolveShellWrapperTransportArgv, S as POSIX_SHELL_WRAPPERS, d as resolveApprovalAuditCandidatePath, k as unwrapKnownShellMultiplexerInvocation, p as resolveCommandResolutionFromArgv, y as resolveExecutableFromPathEnv } from "./exec-safe-bin-trust-DOTK0AC_.js";
import { t as formatCliCommand } from "./command-format-Cf6Wzk70.js";
import { _ as resolveNodeSystemdServiceName, g as resolveNodeLaunchAgentLabel, u as formatNodeServiceDescription, v as resolveNodeWindowsTaskName } from "./paths-DrEUTK1s.js";
import { i as resolveDaemonNodeBinDir, n as emitDaemonInstallRuntimeWarning, o as resolveNodeProgramArguments, r as resolveDaemonInstallRuntimeInputs } from "./auth-token-resolution-D7L_BMBF.js";
import { s as buildNodeServiceEnvironment } from "./runtime-paths-rDa4UApJ.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-C7WBbgHY.js";
import { f as GatewayClient } from "./method-scopes-5jCaY0oV.js";
import { n as loadOrCreateDeviceIdentity } from "./device-identity-DBalpSbl.js";
import { d as resolveRuntimeStatusColor, g as installDaemonServiceAndEmit, m as buildDaemonServiceSnapshot, n as createDaemonInstallActionContext, p as parsePort, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-Du0z0ufj.js";
import { a as formatRuntimeStatus, i as buildPlatformServiceStartHints, r as buildPlatformRuntimeLogHints } from "./systemd-hints-BL3siP5f.js";
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-CENtD9pQ.js";
import { d as getMachineDisplayName, n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-BJ6SgVIn.js";
import { t as splitShellArgs } from "./shell-argv-CO8xtR1h.js";
import { A as saveExecApprovals, B as detectInterpreterInlineEvalArgv, C as requiresExecApproval, E as resolveExecApprovals, H as analyzeArgvCommand, J as resolvePlannedSegmentArgv, M as evaluateExecAllowlist, N as evaluateShellAllowlist, a as addDurableCommandApproval, b as recordAllowlistMatchesUse, d as mergeExecApprovalsSocketDefaults, j as requestJsonlSocket, o as ensureExecApprovals, p as normalizeExecApprovals, s as hasDurableExecApproval, v as persistAllowAlwaysPatterns, y as readExecApprovalsSnapshot, z as describeInterpreterInlineEval } from "./exec-approvals-DPGON5tI.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-B6MQW9T4.js";
import { t as formatHelpExamples } from "./help-format-JZYxhOjU.js";
import { t as resolveGatewayConnectionAuth } from "./connection-auth-DCLysxNd.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-CvVoBq9B.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-Ixg_i22U.js";
import { t as resolveNodeService } from "./node-service-fhG9S7Vq.js";
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-D2Q-lBA8.js");
