...
import { t as DEFAULT_AGENT_ID } from "./session-key-CJfa_Nnz.js";
...
import { i as hasNonEmptyString } from "./channel-target-gAsvuN4R.js";
import { t as hasPotentialConfiguredChannels } from "./config-presence-DkN0oRLk.js";
import { i as normalizeTrustedSafeBinDirs, o as listRiskyConfiguredSafeBins } from "./exec-safe-bin-trust-DOTK0AC_.js";
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-sqGnxeT3.js";
...
import { V as isInterpreterLikeAllowlistPattern, l as loadExecApprovals } from "./exec-approvals-DPGON5tI.js";
...
import { n as collectEnabledInsecureOrDangerousFlags, t as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-CDiKi9UA.js";
import path from "node:path";
import { isIP } from "node:net";
//#region src/security/audit-deep-code-safety.ts
let auditDeepModulePromise;
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-jed_zkkI.js");
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-CHdWE64I.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-Czl0YsJ3.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-9A0Tq2Ct.js");
...
async function loadPluginMetadataRegistryLoaderModule() {
	pluginMetadataRegistryLoaderModulePromise ??= import("./metadata-registry-loader-CxqQOX2a.js");
...
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-CBYdZ3ch.js"),
		import("./probe-auth-BcDO9Tfv.js"),
		import("./probe-D-S_0Au5.js")
