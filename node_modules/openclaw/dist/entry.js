...
import { N as isRootHelpInvocation, P as isRootVersionInvocation } from "./logger--Y4fLUmQ.js";
import { t as resolveCliArgvInvocation } from "./argv-invocation-BeolA8Ck.js";
import { a as parseCliContainerArgs, n as applyCliProfileEnv, o as resolveCliContainerTarget, r as parseCliProfileArgs, t as normalizeWindowsArgv } from "./windows-argv-BJImglD5.js";
...
if (!isMainModule({
	...
	const { installGaxiosFetchCompat } = await import("./gaxios-fetch-compat-CZ06nb92.js");
	...
	function tryHandleRootVersionFastPath(argv) {
		...
		Promise.all([import("./version-1ekIlWyI.js"), import("./git-commit-BbuAfalX.js")]).then(([{ VERSION }, { resolveCommitHash }]) => {
...
function tryHandleRootHelpFastPath(argv, deps = {}) {
	...
	import("./root-help-metadata-DhcxpekB.js").then(async ({ outputPrecomputedRootHelpText }) => {
...
function runMainOrRootHelp(argv) {
	...
	import("./run-main-GjF7YCnf.js").then(({ runCli }) => runCli(argv)).catch((error) => {
