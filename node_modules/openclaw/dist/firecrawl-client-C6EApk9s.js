...
import { _ as truncateText, a as readResponseText, d as withStrictWebToolsEndpoint, g as markdownToText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey } from "./web-shared-CGUlqLIo.js";
import "./secret-input-DuT2Jtet.js";
import "./security-runtime-CWZDnSsq.js";
import "./provider-web-fetch-BArgcKHw.js";
...
async function postFirecrawlJson(params, parse) {
	...
	return await withStrictWebToolsEndpoint({
		...
		if (!response.ok) {
			...
			const safeDetail = wrapWebContent(String(detail).slice(0, 1e3), "web_fetch");
