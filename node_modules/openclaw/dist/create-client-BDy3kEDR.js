...
import { l as resolveValidatedMatrixHomeserverUrl } from "./config-BqOzcDau.js";
import { a as resolveMatrixStoragePaths, n as maybeMigrateLegacyStorage, o as writeStorageMeta } from "./storage-Ija_m7Ej.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-DcOJIyyL.js"), import("./logging-CVVgyrG5.js")]).then(([sdkModule, loggingModule]) => ({
