...
import { x as buildMediaPayload } from "./reply-payload-BRozqdR-.js";
...
import { r as resolveDefaultGroupPolicy } from "./runtime-group-policy-DUnbv8LI.js";
...
async function resolveMSTeamsInboundMedia(params) {
	...
	if (mediaList.length === 0) {
		if (attachments.some((att) => typeof att.contentType === "string" && att.contentType.startsWith("text/html"))) {
