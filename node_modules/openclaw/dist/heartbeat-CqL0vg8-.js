	...
	for (let i = 0; i < lines.length; i++) {
		...
		if (trimmed.startsWith("- name:")) {
			...
			for (let j = i + 1; j < lines.length; j++) {
				...
				if (nextTrimmed.startsWith("interval:")) interval = nextTrimmed.replace("interval:", "").trim().replace(/^["']|["']$/g, "");
				else if (nextTrimmed.startsWith("prompt:")) prompt = nextTrimmed.replace("prompt:", "").trim().replace(/^["']|["']$/g, "");
