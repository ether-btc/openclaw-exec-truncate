...
import { a as resolveManifestContractPluginIdsByCompatibilityRuntimePath, i as resolveManifestContractPluginIds, r as resolveManifestContractOwnerPluginId } from "./manifest-registry-CNMsaTfa.js";
import { m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir } from "./agent-scope-CYaif3uh.js";
import { d as resolveSecretInputRef } from "./types.secrets-CWvOd-Rt.js";
import { u as secretRefKey } from "./ref-contract-D3xgAKlC.js";
import { a as collectPluginConfigContractMatches, o as resolvePluginConfigContractsById } from "./setup-registry-C-ujkY5_.js";
import { a as normalizePluginsConfig, c as resolveEnableState } from "./config-state-voeu0Fr5.js";
import { c as getBootstrapChannelSecrets } from "./channel-target-gAsvuN4R.js";
import { t as loadBundledChannelSecretContractApi } from "./channel-contract-api-DHABLuw4.js";
import "./shared-BRuFmZh9.js";
import { o as resolveSecretRefValues } from "./resolve-CEgwP_Ay.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-DYsc_G0J.js";
import { t as createGatewayCredentialPlan } from "./credential-planner-DRogptU0.js";
import { n as resolveEffectiveMediaEntryCapabilities, r as buildMediaUnderstandingRegistry, t as resolveConfiguredMediaEntryCapabilities } from "./entry-capabilities-DMcB3Yos.js";
import { a as createLazyRuntimeSurface } from "./lazy-runtime-CXfhfZLN.js";
import { c as pushInactiveSurfaceWarning, l as pushWarning, n as collectSecretInputAssignment } from "./runtime-shared-DklVngdc.js";
import { t as collectTtsApiKeyAssignments } from "./runtime-config-collectors-tts-D-K5d3tz.js";
import { r as sortWebSearchProvidersForAutoDetect } from "./web-search-providers.shared-CV0-bEyw.js";
import { r as sortWebFetchProvidersForAutoDetect } from "./web-fetch-providers.shared-CPVZ0qxz.js";
import { i as resolveBundledExplicitWebSearchProvidersFromPublicArtifacts, r as resolveBundledExplicitWebFetchProvidersFromPublicArtifacts } from "./web-provider-public-artifacts.explicit-CgPW2tMx.js";
...
async function resolveRuntimeWebProviderSurface(params) {
	...
	if (!configuredBundledPluginId && params.rawProvider) configuredBundledPluginId = resolveManifestContractOwnerPluginId({
...
const loadRuntimeWebToolsFallbackProviders = createLazyRuntimeSurface(() => import("./runtime-web-tools-fallback.runtime-DhEp3Psa.js"), ({ runtimeWebToolsFallbackProviders }) => runtimeWebToolsFallbackProviders);
const loadRuntimeWebToolsPublicArtifacts = createLazyRuntimeSurface(() => import("./runtime-web-tools-public-artifacts.runtime-Bt52v3IR.js"), (mod) => mod);
...
async function resolveRuntimeWebTools(params) {
	...
	const configuredBundledWebSearchPluginIdHint = rawProvider && hasPluginWebSearchConfig && !hasCustomWebSearchPluginRisk(params.sourceConfig) ? inferSingleBundledPluginScopedWebToolConfigOwner(params.sourceConfig, "webSearch") : void 0;
	...
	if (search || hasPluginWebSearchConfig) {
		...
		const searchSurface = await resolveRuntimeWebProviderSurface({
			...
			resolveProviders: ({ configuredBundledPluginId }) => resolveBundledWebSearchProviders({
				...
				onlyPluginIds: configuredBundledPluginId === void 0 && searchCompatibilityOnlyPluginIds.length > 0 && !hasCustomWebSearchPluginRisk(params.sourceConfig) ? searchCompatibilityOnlyPluginIds : void 0,
