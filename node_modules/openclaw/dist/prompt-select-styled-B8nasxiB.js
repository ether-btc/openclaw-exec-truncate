...
import { o as getResolvedLoggerSettings } from "./logger--Y4fLUmQ.js";
...
import { r as normalizeChatChannelId } from "./ids-DQ8uU6i_.js";
...
import { t as isTruthyEnvValue$1 } from "./env-Bo5AGgpZ.js";
import { _ as readClaudeCliCredentialsCached, m as resolveAuthStorePathForDisplay, n as ensureAuthProfileStore, x as CLAUDE_CLI_PROFILE_ID } from "./store-DjuHA0jA.js";
import { n as formatAuthDoctorHint, t as resolveApiKeyForProfile } from "./auth-profiles-D2m7aC_t.js";
import { a as getModelRefStatus, d as resolveConfiguredModelRef, p as resolveHooksGmailModel } from "./model-selection-ugeESflw.js";
import { n as loadPluginManifestRegistry } from "./manifest-registry-CNMsaTfa.js";
...
import { _ as normalizeAccountId, v as normalizeOptionalAccountId, w as parseAgentSessionKey } from "./session-key-CJfa_Nnz.js";
import { a as resolveAgentDir, m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir } from "./agent-scope-CYaif3uh.js";
import { i as runExec, r as runCommandWithTimeout } from "./exec-CgRcwTDe.js";
import { t as DEFAULT_AGENTS_FILENAME } from "./workspace-Q6iYWMyk.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-BPcTA_Xa.js";
import { B as findLegacyConfigIssues, U as normalizeCompatibilityConfigValues, Yt as resolvePluginProviders, an as runChannelDoctorConfigSequences, en as collectChannelDoctorEmptyAllowlistExtraWarnings, f as readConfigFileSnapshot, in as collectChannelDoctorStaleConfigMutations, ln as listPluginDoctorLegacyConfigRules, nn as collectChannelDoctorPreviewWarnings, on as shouldSkipChannelDoctorDefaultEmptyGroupAllowlistWarning, rn as collectChannelDoctorRepairMutations, sn as applyLegacyDoctorMigrations, tn as collectChannelDoctorMutableAllowlistWarnings, v as writeConfigFile, w as validateConfigObjectWithPlugins } from "./config-DMMR1XE_.js";
import { t as asNullableObjectRecord } from "./record-coerce-Cmt1s1Tr.js";
import { a as hasConfiguredSecretInput, d as resolveSecretInputRef } from "./types.secrets-CWvOd-Rt.js";
import { t as getBundledChannelPlugin } from "./bundled-BUZYiQLp.js";
import { r as listChannelPlugins, t as getChannelPlugin } from "./registry-CCo18B2d.js";
import { a as normalizePluginsConfig, i as normalizePluginId, s as resolveEffectivePluginActivationState } from "./config-state-voeu0Fr5.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-A5w-taRF.js";
import { t as hasBundledChannelPersistedAuthState } from "./persisted-auth-state-Adikr2CV.js";
import { u as listBundledChannelPluginIds } from "./channel-target-gAsvuN4R.js";
import { n as listPotentialConfiguredChannelIds } from "./config-presence-DkN0oRLk.js";
import "./plugins-b-MT-sRH.js";
import "./logging-Bzhr7ofr.js";
import { b as resolveExecutablePath, i as normalizeTrustedSafeBinDirs, n as isTrustedSafeBinPath, o as listRiskyConfiguredSafeBins, p as resolveCommandResolutionFromArgv, t as getTrustedSafeBinDirs } from "./exec-safe-bin-trust-DOTK0AC_.js";
import { n as parseToolsBySenderTypedKey } from "./types.tools--NnCd8iW.js";
import { d as resolveProfileUnusableUntilForDisplay } from "./order-B3ujS8lv.js";
import { t as repairOAuthProfileIdMismatch } from "./repair-DVHGxlwG.js";
import { t as formatCliCommand } from "./command-format-Cf6Wzk70.js";
import { d as resolveGatewayLaunchAgentLabel, g as resolveNodeLaunchAgentLabel, m as resolveGatewayWindowsTaskName, p as resolveGatewaySystemdServiceName } from "./paths-DrEUTK1s.js";
import { t as resolveGatewayAuthToken } from "./auth-token-resolution-D7L_BMBF.js";
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-rDa4UApJ.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint, t as resolveGatewayInstallToken } from "./gateway-install-token-CVYxQ2Nk.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-C7WBbgHY.js";
import { n as hasAmbiguousGatewayAuthModeConfig } from "./auth-mode-policy-5spLJZ3U.js";
import { a as isLoopbackHost, m as resolveGatewayBindHost } from "./net-DUdz9niH.js";
import { o as resolveGatewayAuth } from "./auth-1AVYE1c8.js";
import { n as isPrimarySessionTranscriptFileName, t as formatSessionArchiveTimestamp } from "./artifacts-CIi01-TX.js";
import { i as resolveMainSessionKey } from "./main-session-DaD0xK0B.js";
import "./sessions-Dz-6DI5z.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-iH379dx6.js";
import { n as cleanStaleLockFiles } from "./session-write-lock-BfM3h1Gi.js";
import { t as loadSessionStore } from "./store-load-DF6H9tmN.js";
import { i as resolveAgentSessionDirs } from "./targets-CGUgeaD9.js";
import { n as safeParseWithSchema, t as safeParseJsonWithSchema } from "./zod-parse-DPAgk2k7.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-B4amWWG5.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-Ba2G7Ut-.js";
import { a as guardCancel, d as randomToken, l as printWizardHeader, n as applyWizardMetadata } from "./onboard-helpers-CfSHbg7p.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-COgM_Pez.js";
import { a as inspectPortUsage, s as formatPortDiagnostics } from "./ports-Dj6_uq2y.js";
import { d as uninstallLegacySystemdUnits, i as isSystemdUserServiceAvailable, p as classifySystemdUnavailableDetail } from "./systemd-Clq-b867.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-CkFSPlvH.js";
import { a as formatRuntimeStatus, n as renderSystemdUnavailableHints, o as resolveDaemonContainerContext, r as buildPlatformRuntimeLogHints, t as isSystemdUnavailableDetail } from "./systemd-hints-BL3siP5f.js";
import { n as formatConfigIssueLines } from "./issue-format-C8BtclgC.js";
import { a as readEmbeddedGatewayToken, i as needsNodeRuntimeMigration, n as auditGatewayServiceConfig, t as SERVICE_AUDIT_CODES } from "./service-audit-TpQuoJJp.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-DyQo4hv0.js";
import { n as findExtraGatewayServices, r as renderGatewayServiceCleanupHints } from "./inspect-Ca_OKc8T.js";
import { r as loadModelCatalog } from "./model-catalog-xMydRuQF.js";
import { n as buildBootstrapInjectionStats, t as analyzeBootstrapBudget, u as resolveBootstrapContextForRun } from "./bootstrap-budget-cquxQ6fH.js";
import { g as resolveBootstrapMaxChars, v as resolveBootstrapTotalMaxChars } from "./pi-embedded-helpers-vgYbNZYl.js";
import { d as DEFAULT_SANDBOX_IMAGE, l as DEFAULT_SANDBOX_BROWSER_IMAGE, r as resolveSandboxScope } from "./config-CftrK-0a.js";
import { s as resolveApiKeyForProvider } from "./model-auth-CWTISnDH.js";
import { l as loadExecApprovals } from "./exec-approvals-DPGON5tI.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-B6MQW9T4.js";
import { n as buildGatewayConnectionDetails, r as callGateway } from "./call-BjnDacVz.js";
import { a as DeliveryThreadIdFieldSchema, c as TrimmedNonEmptyStringFieldSchema, o as LowercaseNonEmptyStringFieldSchema, t as inferLegacyName, u as parseOptionalField } from "./normalize-DU3oUhZ-.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-CyoHsIP3.js";
import { i as listRouteBindings } from "./bindings-BMV0VF4S.js";
import { M as listTaskFlowRecords, d as listTasksForFlowId } from "./task-registry-DZhCCL0e.js";
import "./runtime-internal-BrmVr5rM.js";
import { t as note$1 } from "./note-Do_0W7LQ.js";
import "./sandbox-BXvvl5DB.js";
import { n as getActiveMemorySearchManager, r as resolveActiveMemoryBackendConfig } from "./memory-runtime-uAB9bkjW.js";
import { t as resolveMemorySearchConfig } from "./memory-search-BoQ5so6w.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-BPPih9a8.js";
import { a as readChannelAllowFromStore } from "./pairing-store-C6M42esc.js";
import { r as resolveDmAllowState } from "./dm-policy-shared-CXuIpNws.js";
import { n as logConfigUpdated } from "./logging-BUckDeiV.js";
import { n as resolveCronStorePath, r as saveCronStore, t as loadCronStore } from "./store-CZHRy7S3.js";
import { i as resolveBundledPluginSources } from "./bundled-sources-A77STSeC.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-DZpwHHrg.js";
import { a as listBuiltinAutoSelectMemoryEmbeddingProviderDoctorMetadata, n as auditShortTermPromotionArtifacts, o as repairShortTermPromotionArtifacts, r as getBuiltinMemoryEmbeddingProviderDoctorMetadata } from "./memory-core-engine-runtime-Chwia-ce.js";
import { t as resolveMemoryBackendConfig } from "./backend-config-B0yf1oUt.js";
import "./engine-embeddings-E5kU8ZAT.js";
import { t as hasConfiguredMemorySecretInput } from "./secret-input-BfU7HVQ1.js";
import { t as checkQmdBinaryAvailability } from "./engine-qmd-hkDGi5O2.js";
import "./engine-storage-DYudODf5.js";
import "./secret-DxnicRWO.js";
import { t as noteChromeMcpBrowserReadiness } from "./browser-doctor-DxZr04ES.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DC8LBh9R.js";
import { i as buildPluginDiagnosticsReport, r as buildPluginCompatibilityWarnings } from "./status-C9YV9RW1.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-2_XXEvgt.js";
import { n as resolveExecPolicyScopeSnapshot } from "./exec-approvals-effective-CGZeMraa.js";
import { r as healthCommand } from "./health-D3dexQtc.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-DFd7qKwJ.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-De1_tEoM.js";
import { t as formatHealthCheckFailure } from "./health-format-DCzJNGfN.js";
import { a as stripUnknownConfigKeys, i as resolveConfigPathTarget, n as formatConfigPath, r as noteOpencodeProviderOverrides, t as runDoctorConfigPreflight } from "./doctor-config-preflight-D0DsU4IU.js";
import { a as runChannelPluginStartupMaintenance, i as normalizeCronJobIdentityFields, o as runGatewayUpdate, t as coerceFiniteScheduleNumber } from "./schedule-BH3SgDuw.js";
import { n as doctorShellCompletion } from "./doctor-completion-Dz7VnVUe.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-BZQ3UbQB.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-BqKTQx8o.js";
import { a as runLegacyStateMigrations, n as detectLegacyStateMigrations } from "./state-migrations-CSyIw_DM.js";
import "./doctor-state-migrations-Cg7eU1ff.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./provider-openai-codex-oauth-tls-CoIO-COY.js";
