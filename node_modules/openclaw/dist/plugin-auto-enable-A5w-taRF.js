...
import { n as loadPluginManifestRegistry, r as resolveManifestContractOwnerPluginId } from "./manifest-registry-CNMsaTfa.js";
import { t as isBlockedObjectKey } from "./prototype-keys-BWjW0VW8.js";
import { t as resolvePluginSetupAutoEnableReasons } from "./setup-registry-C-ujkY5_.js";
import { r as withBundledPluginVitestCompat } from "./bundled-compat-DOAowBD7.js";
import { a as normalizePluginsConfig, s as resolveEffectivePluginActivationState } from "./config-state-voeu0Fr5.js";
import { n as listPotentialConfiguredChannelIds, t as hasPotentialConfiguredChannels } from "./config-presence-DkN0oRLk.js";
import { t as isChannelConfigured } from "./channel-configured-BOpIhLAy.js";
import { t as ensurePluginAllowlisted } from "./plugins-allowlist-D-Rz4FGU.js";
...
function resolveDiscoveredProviderPluginIds(params) {
	...
	return loadPluginManifestRegistry({
		...
		workspaceDir: params.workspaceDir,
		env: params.env
	}).plugins.filter((plugin) => plugin.providers.length > 0 && (!onlyPluginIdSet || onlyPluginIdSet.has(plugin.id))).map((plugin) => plugin.id).toSorted((left, right) => left.localeCompare(right));
}
