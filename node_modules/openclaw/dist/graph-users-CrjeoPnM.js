...
async function loadMSTeamsSdk() {
	const [appsModule, apiModule] = await Promise.all([import("./dist-DpU-pyvM.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-DeDJoxCb.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]);
	return {
		App: appsModule.App,
...
async function createBotFrameworkJwtValidator(creds) {
	const { JwtValidator } = await import("./jwt-validator-BN5SbE5n.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
...
//#endregion
export { isLikelyImageAttachment as A, resolveMSTeamsCredentials as B, GRAPH_ROOT as C, extractInlineImageCandidates as D, extractHtmlFromAttachment as E, resolveMediaSsrfPolicy as F, resolveRequestUrl as I, safeFetchWithPolicy as L, normalizeContentType as M, readNestedString as N, inferPlaceholder as O, resolveAttachmentFetchPolicy as P, safeHostForUrl as R, ATTACHMENT_TAG_RE as S, applyAuthorizationHeaderForUrl as T, ensureUserAgentHeader as _, listChannelsForTeam as a, formatUnknownError as b, postGraphBetaJson as c, readAccessToken as d, createBotFrameworkJwtValidator as f, buildUserAgent as g, loadMSTeamsSdkWithAuth as h, fetchGraphJson as i, isUrlAllowed as j, isDownloadableAttachment as k, postGraphJson as l, createMSTeamsTokenProvider as m, deleteGraphRequest as n, listTeamsByName as o, createMSTeamsAdapter as p, escapeOData as r, normalizeQuery as s, searchGraphUsers as t, resolveGraphToken as u, classifyMSTeamsSendError as v, IMG_SRC_RE as w, isRevokedProxyError as x, formatMSTeamsSendErrorHint as y, hasConfiguredMSTeamsCredentials as z };
