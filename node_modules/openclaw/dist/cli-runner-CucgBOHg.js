...
import { t as isTruthyEnvValue } from "./env-Bo5AGgpZ.js";
import { _ as readClaudeCliCredentialsCached, a as loadAuthProfileStoreForRuntime, v as readCodexCliCredentialsCached } from "./store-DjuHA0jA.js";
import { O as resolveRuntimeCliBackends, f as resolveDefaultModelForAgent } from "./model-selection-ugeESflw.js";
import { r as normalizeProviderId } from "./provider-id-CAe4L4g9.js";
import { p as scopedHeartbeatWakeOptions } from "./session-key-CJfa_Nnz.js";
import { y as resolveSessionAgentIds } from "./agent-scope-CYaif3uh.js";
import { a as shouldLogVerbose } from "./globals-CuxBmXL5.js";
import { un as resolveOwnerDisplaySetting } from "./config-DMMR1XE_.js";
import { n as resolvePluginSetupCliBackend } from "./setup-registry-C-ujkY5_.js";
import { E as applyMergePatch, S as loadEnabledBundleMcpConfig, b as extractMcpServerMap } from "./loader-CVkGO8jl.js";
import { o as sanitizeHostExecEnv } from "./host-env-security-DdUy_DwF.js";
import { n as buildTtsSystemPromptHint } from "./tts-D8dXxXRC.js";
import { a as prependBootstrapPromptWarning, f as resolveHeartbeatPromptForSystemPrompt, i as buildBootstrapTruncationReportMeta, l as makeBootstrapWarn, n as buildBootstrapInjectionStats, r as buildBootstrapPromptWarning, t as analyzeBootstrapBudget, u as resolveBootstrapContextForRun } from "./bootstrap-budget-cquxQ6fH.js";
import { _ as resolveBootstrapPromptTruncationWarningMode, g as resolveBootstrapMaxChars, v as resolveBootstrapTotalMaxChars } from "./pi-embedded-helpers-vgYbNZYl.js";
import { m as isFailoverErrorMessage, n as classifyFailoverReason } from "./errors-DEuzndId.js";
import { n as sanitizeImageBlocks } from "./tool-images-DemYfIs0.js";
...
import { n as detectRuntimeShell, t as getProcessSupervisor } from "./supervisor-Beu_QeAk.js";
import { n as extensionForMime } from "./mime-B2s7EGtL.js";
import { i as isFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-BOJISXS1.js";
import { a as buildSystemPromptParams, c as buildAgentSystemPrompt, i as buildSystemPromptReport, n as detectImageReferences, o as redactRunIdentifier, r as loadImageFromRef, s as resolveRunWorkspaceDir, u as resolveSystemPromptOverride } from "./images-C6JsFbL2.js";
import { i as emitAgentEvent } from "./agent-events-D0ACUj3I.js";
import { t as KeyedAsyncQueue } from "./keyed-async-queue-Bqr0NMca.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-DwoRj1ZG.js";
import { t as buildModelAliasLines } from "./model-alias-lines-CskC_-sE.js";
import { n as CLI_RESUME_WATCHDOG_DEFAULTS, r as CLI_WATCHDOG_MIN_TIMEOUT_MS, t as CLI_FRESH_WATCHDOG_DEFAULTS } from "./cli-watchdog-defaults-CorxeZ07.js";
...
function parseClaudeCliJsonlResult(params) {
	if (!isClaudeCliProvider$1(params.providerId)) return null;
...
function buildCliArgs(params) {
	...
	if (!params.useResume && params.systemPrompt && params.backend.systemPromptArg) args.push(params.backend.systemPromptArg, stripSystemPromptCacheBoundary(params.systemPrompt));
...
function resolveSetupCliBackendPolicy(provider) {
	const entry = resolvePluginSetupCliBackend({ backend: provider });
	if (!entry) return;
	return {
...
const prepareDeps = {
	...
	resolveOpenClawDocsPath: async (params) => (await import("./docs-path-rTZL5L7y.js")).resolveOpenClawDocsPath(params)
};
async function prepareCliRunContext(params) {
	...
	const systemPrompt = resolveSystemPromptOverride({
		config: params.config,
		agentId: sessionAgentId
	}) ?? buildSystemPrompt({
		workspaceDir,
