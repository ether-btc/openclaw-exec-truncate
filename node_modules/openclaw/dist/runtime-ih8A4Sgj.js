...
import { i as isFailoverError, r as describeFailoverError } from "./failover-error-BOJISXS1.js";
import { a as resolveCapabilityModelCandidates, c as resolveClosestSize, l as throwCapabilityGenerationFailure, n as deriveAspectRatioFromSize, o as resolveClosestAspectRatio, r as hasMediaNormalizationEntry, s as resolveClosestResolution, t as buildNoCapabilityModelConfiguredMessage } from "./runtime-shared-uPe9FV6j.js";
import { n as listVideoGenerationProviders, r as parseVideoGenerationModelRef, t as getVideoGenerationProvider } from "./provider-registry-zXTldu_Y.js";
	...
	for (const candidate of candidates) {
		...
		try {
			...
			return {
				...
				metadata: {
					...result.metadata,
					...sanitized.normalization?.size?.requested !== void 0 && sanitized.normalization.size.applied !== void 0 ? {
						requestedSize: sanitized.normalization.size.requested,
						normalizedSize: sanitized.normalization.size.applied
					} : {},
					...sanitized.normalization?.aspectRatio?.applied !== void 0 ? {
						...sanitized.normalization.aspectRatio.requested !== void 0 ? { requestedAspectRatio: sanitized.normalization.aspectRatio.requested } : {},
					...
					...sanitized.normalization?.resolution?.requested !== void 0 && sanitized.normalization.resolution.applied !== void 0 ? {
					...
					...sanitized.normalization?.durationSeconds?.requested !== void 0 && sanitized.normalization.durationSeconds.applied !== void 0 ? {
						...
						...sanitized.normalization.durationSeconds.supportedValues?.length ? { supportedDurationSeconds: sanitized.normalization.durationSeconds.supportedValues } : {}
					} : {}
				}
			};
		} catch (err) {
