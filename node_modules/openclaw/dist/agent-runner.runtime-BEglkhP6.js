...
import { o as isInternalMessageChannel, p as resolveMessageChannel, s as isMarkdownCapableMessageChannel } from "./message-channel-BdU8JCBW.js";
...
import { s as isCliProvider } from "./model-selection-ugeESflw.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-CJfa_Nnz.js";
import { _ as resolveRunModelFallbacksOverride, v as resolveSessionAgentId } from "./agent-scope-CYaif3uh.js";
import { r as logVerbose } from "./globals-CuxBmXL5.js";
import "./defaults-BPcTA_Xa.js";
import { c as loadConfig } from "./config-DMMR1XE_.js";
import { g as resolveMemoryFlushPlan } from "./memory-state-CeRc_0e1.js";
import { _ as resolveGroupSessionKey, c as updateSessionStore, l as updateSessionStoreEntry } from "./store-CeqUIT7u.js";
import "./sessions-Dz-6DI5z.js";
import { a as resolveSessionTranscriptPath, i as resolveSessionFilePathOptions, r as resolveSessionFilePath } from "./paths-iH379dx6.js";
...
import { l as estimateMessagesTokens, n as isLikelyExecutionAckPrompt, nt as runWithModelFallback, rt as LiveSessionModelSwitchError, s as compactEmbeddedPiSession, t as runEmbeddedPiAgent, tt as isFallbackSummaryError, u as readPostCompactionContext } from "./pi-embedded-CNTNdlGw.js";
import { t as lookupContextTokens } from "./context-CIaFOK75.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-CgDWHf4_.js";
import { c as hasNonzeroUsage, o as derivePromptTokens, s as deriveSessionTotalTokens, u as normalizeUsage } from "./chat-envelope-CwV6pYqA.js";
import { i as readSessionMessages } from "./session-utils.fs-B-Z_mm6Z.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-CgHHhFXy.js";
import { s as stripHeartbeatToken } from "./heartbeat-CqL0vg8-.js";
import { a as generateSecureUuid } from "./secure-random-Dso58VT9.js";
import { n as isDiagnosticsEnabled, t as emitDiagnosticEvent } from "./diagnostic-events-D6dtJHZH.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-BjuwOmis.js";
import { o as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-cquxQ6fH.js";
import "./pi-embedded-helpers-vgYbNZYl.js";
import { C as isBillingErrorMessage, S as sanitizeUserFacingText, T as isRateLimitErrorMessage, d as isCompactionFailureError, f as isContextOverflowError, h as isLikelyContextOverflowError, t as BILLING_ERROR_USER_MESSAGE, w as isOverloadedErrorMessage, y as isTransientHttpError } from "./errors-DEuzndId.js";
import { n as resolveSandboxConfigForAgent } from "./config-CftrK-0a.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-BJzbQ0Dl.js";
import "./thinking-D0jPPsk8.js";
import { c as resolveModelAuthMode } from "./model-auth-CWTISnDH.js";
import { a as resolveSandboxedMediaSource, t as assertMediaNotDataUrl } from "./sandbox-paths-CvEDn46r.js";
import { h as resolvePathFromInput, o as parseReplyDirectives, p as resolveEffectiveToolFsWorkspaceOnly } from "./deliver-BwSfz6ox.js";
import { r as enqueueSystemEvent } from "./system-events-BWY8jYOz.js";
import { a as isAudioFileName } from "./mime-B2s7EGtL.js";
import { p as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-BRozqdR-.js";
import { i as isRenderablePayload, n as applyReplyThreading, t as applyReplyTagsToPayload } from "./reply-payloads-BrqxMYv6.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-Dp0_TUzd.js";
import { n as filterMessagingToolMediaDuplicates, r as shouldSuppressMessagingToolReplies, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-0vLoBouk.js";
import { h as replyRunRegistry, m as createReplyOperation, p as ReplyRunAlreadyActiveError, s as queueEmbeddedPiMessage } from "./runs-Ds1qZo-R.js";
import { u as saveMediaSource } from "./store-6Eiv7dYr.js";
import { i as emitAgentEvent, u as registerAgentRunContext } from "./agent-events-D0ACUj3I.js";
import { a as scheduleFollowupDrain, n as enqueueFollowupRun, o as refreshQueuedFollowupSession } from "./queue-C2eYTgDP.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-C9Im4SN4.js";
import { a as ensureSandboxWorkspaceForSession } from "./sandbox-BXvvl5DB.js";
import { n as resolveCronStorePath, t as loadCronStore } from "./store-CZHRy7S3.js";
import { r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-BlHwKPvB.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-BrHwQ4il.js";
import { r as resolveActiveRunQueueAction, t as createTypingSignaler } from "./typing-mode-BIpRZ9gh.js";
import { a as setCliSessionBinding, o as setCliSessionId, r as getCliSessionBinding, t as runCliAgent } from "./cli-runner-CucgBOHg.js";
import { i as resolveFallbackTransition, n as buildFallbackNotice, t as buildFallbackClearedNotice } from "./fallback-state-Cn3LKAcQ.js";
import { a as resolveModelFallbackOptions, i as isBunFetchSocketError, o as resolveRunAuthProfile, r as formatBunFetchSocketError, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-D39gx8OH.js";
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "./block-reply-pipeline-CjCkmQ4a.js";
import { n as incrementCompactionCount } from "./session-updates-CCG23-KT.js";
...
function loadReplyPayloadsDedupeRuntime() {
	replyPayloadsDedupeRuntimePromise ??= import("./reply-payloads-dedupe.runtime-ch_mqJE1.js");
