...
import { a as warnMissingProviderGroupPolicyFallbackOnce, r as resolveDefaultGroupPolicy } from "./runtime-group-policy-DUnbv8LI.js";
...
import { n as isZaloSenderAllowed, t as evaluateZaloGroupAccess } from "./group-access-DfD2PNdn.js";
import { t as getZaloRuntime } from "./runtime-api-FbL2bnDZ.js";
import { a as getUpdates, c as sendMessage, l as sendPhoto, n as ZaloApiError, o as getWebhookInfo, r as deleteWebhook, s as sendChatAction, t as resolveZaloProxyFetch, u as setWebhook } from "./proxy-CgaTLf8y.js";
...
async function handleZaloWebhookRequest(req, res) {
	const { handleZaloWebhookRequest: handleZaloWebhookRequestInternal } = await import("./monitor.webhook-fOwPUvK_.js");
...
async function monitorZaloProvider(options) {
	...
	try {
		if (useWebhook) {
			const { registerZaloWebhookTarget } = await import("./monitor.webhook-fOwPUvK_.js");
