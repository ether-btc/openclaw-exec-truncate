...
import { c as resolveProviderRequestPolicyConfig, n as buildProviderRequestDispatcherPolicy } from "./provider-request-config-Di42ftNt.js";
...
async function postTranscriptionRequest(params) {
	return fetchWithTimeoutGuarded(params.url, {
		...
		body: params.body
	}, params.timeoutMs, params.fetchFn, params.allowPrivateNetwork || params.dispatcherPolicy || params.pinDns !== void 0 || params.auditContext ? {
