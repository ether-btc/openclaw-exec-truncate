...
import { r as createEnvPatchedAccountSetupAdapter } from "./setup-helpers-mv9ZHZDG.js";
...
import { n as createDangerousNameMatchingMutableAllowlistWarningCollector } from "./channel-policy-DM1sGttY.js";
import { A as promptLegacyChannelAllowFromForAccount, I as resolveEntriesWithOptionalToken, J as setSetupChannelEnabled, S as parseMentionOrPrefixedId, T as patchChannelConfigForAccount, b as noteChannelLookupFailure, f as createStandardChannelSetupStatus, i as createAccountScopedGroupAccessSection, o as createLegacyCompatChannelDmPolicy, r as createAccountScopedAllowFromSection, x as noteChannelLookupSummary } from "./setup-wizard-helpers-BSnJD8SD.js";
import "./setup-runtime-CFbERVvd.js";
import "./setup-tools-f7pUtFaE.js";
import "./account-resolution-APiOO_aW.js";
import { a as resolveSlackAccount, i as resolveDefaultSlackAccountId, n as listSlackAccountIds, r as mergeSlackAccountConfig } from "./accounts-D4W0Kgk6.js";
import { n as isSlackInteractiveRepliesEnabled } from "./interactive-replies-CSBBnoJ5.js";
import { t as getChatChannelMeta } from "./channel-api-BDk1gpX_.js";
import { t as SlackChannelConfigSchema } from "./config-schema-C2fDErpb.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-Byp5_Sbd.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-BF-zlPPn.js";
...
function setSlackInteractiveReplies(cfg, accountId, interactiveReplies) {
	...
	return patchChannelConfigForAccount({
		...
		channel: SLACK_CHANNEL,
		accountId,
		patch: { capabilities: Array.isArray(capabilities) ? interactiveReplies ? [...new Set([...capabilities, "interactiveReplies"])] : capabilities.filter((entry) => normalizeLowercaseStringOrEmpty(String(entry)) !== "interactivereplies") : {
