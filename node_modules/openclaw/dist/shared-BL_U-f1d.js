...
import { a as resolveMatrixAuthContext, i as resolveMatrixAuth } from "./config-BqOzcDau.js";
...
async function loadMatrixCreateClientDeps() {
	matrixCreateClientDepsPromise ??= import("./create-client-BjnRZj-Y.js").then((runtime) => ({ createMatrixClient: runtime.createMatrixClient }));
