...
import { E as splitTrailingAuthProfile, f as resolveDefaultModelForAgent, i as buildModelAliasIndex, m as resolveModelRefFromString } from "./model-selection-ugeESflw.js";
import { a as resolveAgentDir, o as resolveAgentEffectiveModelPrimary } from "./agent-scope-CYaif3uh.js";
import "./defaults-BPcTA_Xa.js";
import { n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel } from "./model-auth-CWTISnDH.js";
...
async function setRuntimeApiKeyForCompletion(params) {
	if (params.model.provider === "github-copilot") {
		const { resolveCopilotApiToken } = await import("./github-copilot-token-BZzShVBI.js");
