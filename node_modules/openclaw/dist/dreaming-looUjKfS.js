...
import { o as parseUsageCountedSessionIdFromFileName } from "./artifacts-CIi01-TX.js";
import "./text-runtime-Y7jeuzOm.js";
import "./error-runtime-OaZzlNpe.js";
import { n as appendMemoryHostEvent } from "./events-C_2CgSbd.js";
import { B as resolveMemoryLightDreamingConfig, F as resolveMemoryDeepDreamingConfig, M as formatMemoryDreamingDay, P as resolveMemoryCorePluginConfig, V as resolveMemoryRemDreamingConfig, z as resolveMemoryDreamingWorkspaces } from "./dreaming-58cRx0K5.js";
...
import "./memory-host-events-CttC5fJU.js";
import { n as withTrailingNewline, t as replaceManagedMarkdownBlock } from "./memory-host-markdown-DSBvKYY4.js";
import { a as readShortTermRecallEntries, c as repairShortTermPromotionArtifacts, i as rankShortTermPromotionCandidates, n as applyShortTermPromotions, o as recordDreamingPhaseSignals, s as recordShortTermRecalls } from "./short-term-promotion-CF110O8c.js";
import { n as normalizeTrimmedString, t as includesSystemEventToken } from "./dreaming-shared-BzcKRN-h.js";
...
function tokenizeSnippet(snippet) {
	return new Set(normalizeLowercaseStringOrEmpty(snippet).split(/[^a-z0-9]+/i).map((token) => token.trim()).filter(Boolean));
}
function jaccardSimilarity(left, right) {
	const leftTokens = tokenizeSnippet(left);
	const rightTokens = tokenizeSnippet(right);
	if (leftTokens.size === 0 || rightTokens.size === 0) return normalizeLowercaseStringOrEmpty(left) === normalizeLowercaseStringOrEmpty(right) ? 1 : 0;
	let intersection = 0;
...
function resolveCronServiceFromStartupEvent(event) {
	...
	const deps = asNullableRecord(context?.deps);
