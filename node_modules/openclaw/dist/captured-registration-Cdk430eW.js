...
import { C as isSubagentSessionKey, c as normalizeAgentId, p as scopedHeartbeatWakeOptions, w as parseAgentSessionKey } from "./session-key-CJfa_Nnz.js";
import { i as resolveAgentConfig, m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir } from "./agent-scope-CYaif3uh.js";
import { r as logVerbose } from "./globals-CuxBmXL5.js";
import { c as loadConfig } from "./config-DMMR1XE_.js";
import { t as buildPluginApi } from "./api-builder-DR8O_7Wt.js";
...
import { i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-iH379dx6.js";
import { a as normalizeDeliveryContext, r as formatConversationTarget, s as resolveConversationDeliveryTarget, t as deliveryContextFromSession } from "./delivery-context-DG5DsDyV.js";
...
import "./heartbeat-CqL0vg8-.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-BJzbQ0Dl.js";
import { n as requestHeartbeatNow, t as areHeartbeatsEnabled } from "./heartbeat-wake-B6KiI76E.js";
import { r as enqueueSystemEvent } from "./system-events-BWY8jYOz.js";
import { r as callGateway } from "./call-BjnDacVz.js";
import { b as resolveInternalSessionKey, x as resolveMainSessionAlias } from "./subagents-format-B2SdBUFJ.js";
import { l as onAgentEvent } from "./agent-events-D0ACUj3I.js";
import { i as createRunningTaskRun, s as recordTaskRunProgressByRunId } from "./task-executor-CT6-JwTf.js";
import { i as isSessionBindingError, r as getSessionBindingService } from "./session-binding-service-BQQ2yli6.js";
import { t as resolveConversationIdFromTargets } from "./conversation-id-DYhAFOEp.js";
import { n as getAcpSessionManager } from "./manager-Cv_GZCdX.js";
import { n as readAcpSessionEntry } from "./session-meta-C5LTJ169.js";
import { n as resolveAcpAgentPolicyError, t as isAcpEnabledByPolicy } from "./policy-6zBTSZPU.js";
import { r as resolveAcpThreadSessionDetailLines, t as resolveAcpSessionCwd } from "./session-identifiers-qkbF5HDz.js";
import { _ as resolveThreadBindingThreadName, d as resolveThreadBindingSpawnPolicy, g as resolveThreadBindingIntroText, l as resolveThreadBindingMaxAgeMsForChannel, n as formatThreadBindingSpawnDisabledError, o as resolveThreadBindingIdleTimeoutMsForChannel, t as formatThreadBindingDisabledError } from "./thread-bindings-policy-teIXk5UU.js";
...
function resolveConversationIdForThreadBinding(params) {
	...
	const pluginResolvedConversationId = normalizedChannelId ? getChannelPlugin(normalizedChannelId)?.messaging?.resolveInboundConversation?.({
		to: params.groupId ?? params.to,
		conversationId: params.groupId ?? params.to,
		threadId: params.threadId,
		isGroup: true
	})?.conversationId : null;
	if (normalizeOptionalString(pluginResolvedConversationId)) return normalizeOptionalString(pluginResolvedConversationId);
	if (channelKey === "line") {
		const lineConversationId = normalizeLineConversationIdFallback(params.groupId ?? params.to);
		if (lineConversationId) return lineConversationId;
	}
	...
	if (genericConversationId) return genericConversationId;
}
...
function resolveAcpSpawnBootstrapDeliveryPlan(params) {
	...
	const boundThreadId = boundThreadIdRaw ? normalizeOptionalString(String(boundThreadIdRaw)) : void 0;
	...
	const bindingMatchesRequesterConversation = Boolean(params.requester.origin?.channel && params.binding?.conversation.channel === params.requester.origin.channel && params.binding?.conversation.accountId === requesterAccountId && requesterConversationId && params.binding?.conversation.conversationId === requesterConversationId);
...
//#endregion
export { spawnAcpDirect as a, resolveIngressWorkspaceOverrideForSpawnedRun as c, resolveAcpSpawnRuntimePolicyError as i, resolveSpawnedWorkspaceInheritance as l, createCapturedPluginRegistration as n, mapToolContextToSpawnedRunMetadata as o, isSpawnAcpAcceptedResult as r, normalizeSpawnedRunMetadata as s, capturePluginRegistration as t, cleanupFailedAcpSpawn as u };
