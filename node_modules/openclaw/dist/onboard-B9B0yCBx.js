...
import { f as readConfigFileSnapshot, r as replaceConfigFile } from "./config-DMMR1XE_.js";
import { s as isValidEnvSecretRefId } from "./types.secrets-CWvOd-Rt.js";
...
import "./daemon-runtime-C7WBbgHY.js";
import { t as resolveControlUiLinks } from "./control-ui-links-CZgAVvbF.js";
import { c as normalizeGatewayTokenInput, d as randomToken, h as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-CfSHbg7p.js";
...
import { c as resolveManifestProviderOnboardAuthFlags, i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-pqfPQM0r.js";
import { t as runSetupWizard } from "./setup-CF4xYlNi.js";
import { r as applyLocalSetupWorkspaceConfig } from "./onboard-config-BCPIgJdl.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-CR-22dJ3.js");
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-D05DGUvw.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-B3mgI8oF.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-Bafw-_iB.js");
