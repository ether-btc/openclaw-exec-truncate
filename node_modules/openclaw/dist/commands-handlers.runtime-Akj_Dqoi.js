...
import { C as normalizeChannelId, _ as GATEWAY_CLIENT_NAMES, d as normalizeMessageChannel, g as GATEWAY_CLIENT_MODES, o as isInternalMessageChannel } from "./message-channel-BdU8JCBW.js";
...
import { t as clearPluginManifestRegistryCache } from "./manifest-registry-CNMsaTfa.js";
import { v as normalizeOptionalAccountId } from "./session-key-CJfa_Nnz.js";
import { a as resolveAgentDir, v as resolveSessionAgentId, y as resolveSessionAgentIds } from "./agent-scope-CYaif3uh.js";
import { r as logVerbose } from "./globals-CuxBmXL5.js";
import { A as getConfigOverrides, F as parseConfigPath, I as setConfigValueAtPath, L as unsetConfigValueAtPath, M as setConfigOverride, N as unsetConfigOverride, P as getConfigValueAtPath, f as readConfigFileSnapshot, j as resetConfigOverrides, v as writeConfigFile, w as validateConfigObjectWithPlugins } from "./config-DMMR1XE_.js";
import { i as normalizeChannelId$1, t as getChannelPlugin } from "./registry-CCo18B2d.js";
import { n as resolveChannelApprovalCapability } from "./plugins-b-MT-sRH.js";
import { n as createInternalHookEvent, p as triggerInternalHook } from "./internal-hooks-CyEt2RrF.js";
import { t as parseDurationMs } from "./parse-duration-6N5Yr-j-.js";
import { c as updateSessionStore } from "./store-CeqUIT7u.js";
import "./sessions-Dz-6DI5z.js";
import { i as resolveSessionFilePathOptions, n as resolveDefaultSessionStorePath, r as resolveSessionFilePath } from "./paths-iH379dx6.js";
import { a as resolveFreshSessionTotalTokens } from "./types-rNu4VxRu.js";
import { t as loadSessionStore } from "./store-load-DF6H9tmN.js";
import { r as isRestartEnabled, t as isCommandFlagEnabled } from "./commands-B2SZ59iW.js";
import { t as ensureOpenClawModelsJson } from "./models-config-CUlWj2Y0.js";
import { t as requireApiKey } from "./model-auth-runtime-shared-DWnwzYsJ.js";
import { a as discoverModels, i as discoverAuthStorage } from "./pi-model-discovery-C6Mg140b.js";
import { ct as createExecTool, d as stripToolResultDetails, p as createOpenClawCodingTools } from "./pi-embedded-CNTNdlGw.js";
import { i as formatUsd, r as formatTokenCount } from "./usage-format-CgDWHf4_.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-DOTNAI7q.js";
import { t as diag } from "./diagnostic-JMgVFgbe.js";
import { S as setTtsProvider, _ as setLastTtsAttempt, a as getTtsMaxLength, b as setTtsEnabled, c as isTtsEnabled, h as resolveTtsPrefsPath, i as getResolvedSpeechProviderConfig, l as isTtsProviderConfigured, m as resolveTtsConfig, n as buildTtsSystemPromptHint, o as getTtsProvider, r as getLastTtsAttempt, s as isSummarizationEnabled, v as setSummarizationEnabled, w as textToSpeech, x as setTtsMaxLength } from "./tts-D8dXxXRC.js";
import { t as analyzeBootstrapBudget, u as resolveBootstrapContextForRun } from "./bootstrap-budget-cquxQ6fH.js";
import { g as resolveBootstrapMaxChars, v as resolveBootstrapTotalMaxChars } from "./pi-embedded-helpers-vgYbNZYl.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-BJzbQ0Dl.js";
import "./thinking-D0jPPsk8.js";
import { r as getApiKeyForModel } from "./model-auth-CWTISnDH.js";
import { i as unsetConfiguredMcpServer, r as setConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-BsXkQX0O.js";
import { $ as getFinishedSession, et as getSession, r as getRemoteSkillEligibility, t as canExecRequestNode, y as getSkillsSnapshotVersion } from "./exec-defaults-BxG8oO2K.js";
import { r as callGateway } from "./call-BjnDacVz.js";
import { i as resolveReplyToMode } from "./reply-threading-Dp0_TUzd.js";
import { b as formatConfigWriteDeniedMessageShared, v as authorizeConfigWriteShared, x as resolveConfigWriteTargetFromPathShared, y as canBypassConfigWritePolicyShared } from "./channel-config-helpers-C0sQcDUf.js";
import { t as formatDurationCompact } from "./format-duration-3-yx54b_.js";
import { h as replyRunRegistry, i as getActiveEmbeddedRunSnapshot, t as abortEmbeddedPiRun, w as triggerOpenClawRestart, x as scheduleGatewaySigusr1Restart } from "./runs-Ds1qZo-R.js";
import { a as buildSystemPromptParams, c as buildAgentSystemPrompt, i as buildSystemPromptReport } from "./images-C6JsFbL2.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-DET2ZwlK.js";
import { i as clearSessionQueues } from "./queue-C2eYTgDP.js";
import { r as getSessionBindingService } from "./session-binding-service-BQQ2yli6.js";
import { m as formatThreadBindingDurationLabel } from "./thread-bindings-policy-teIXk5UU.js";
import { i as installPluginFromPath, r as installPluginFromNpmSpec } from "./install-CdwRnnY0.js";
import { r as buildWorkspaceSkillSnapshot } from "./skills-ChGZGQ52.js";
import "./sandbox-BXvvl5DB.js";
import { n as estimateTokensFromChars } from "./cjk-chars-DfcHUkLg.js";
import { r as resolveModelWithRegistry } from "./model-Cp_ctNRF.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-Ba5JWHZr.js";
import { i as matchPluginCommand, n as executePluginCommand } from "./commands-BZTb3kyL.js";
import { p as normalizeCommandBody } from "./commands-registry-PfFcMtDz.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-C2k4EHCa.js";
import { n as formatTimeAgo } from "./format-relative-DfTEpJOP.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-DOpiNSqS.js";
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-BeK9ItnW.js";
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-C6M42esc.js";
import { l as resolveArchiveKind } from "./archive-B5mvY1vi.js";
import { t as isApprovalNotFoundError } from "./approval-errors-CCGC-w8_.js";
import { n as parseActivationCommand } from "./group-activation-gRLuYTMk.js";
import { t as resolveFastModeState } from "./fast-mode-D6W9Pa_w.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-L-aeIodD.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-DFKhjfzi.js";
import { a as shouldPersistAbortCutoff, i as resolveAbortCutoffFromContext, t as applyAbortCutoffToSessionEntry } from "./abort-cutoff-CHna38P9.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-9bPFHOkV.js";
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-De1Eja-5.js";
import { t as extractBtwQuestion } from "./btw-command-zohT5Oia.js";
import "./refresh-Dvk6_9yA.js";
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-H157Hp3T.js";
import { a as buildDisabledCommandReply, c as requireCommandFlagEnabled, l as requireGatewayClientScopeForInternalChannel, o as rejectNonOwnerCommand, r as handleModelsCommand, s as rejectUnauthorizedCommand } from "./commands-models-DiD7RCXo.js";
import { f as resolveSubagentsAction, h as resolveCommandSurfaceChannel, l as resolveHandledPrefix, m as resolveChannelAccountId, p as stopWithText, u as resolveRequesterSessionKey } from "./shared-Rf6rhGeQ.js";
import { t as handleAcpCommand } from "./commands-acp-Bwx9itjk.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-ChboSFqX.js";
import { a as buildToolsMessage, n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./status-CBY7BUi_.js";
import { n as setPluginEnabledInConfig } from "./enable-tWOHDVZb.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-D39gx8OH.js";
import { t as parseConfigValue } from "./config-value-CNQ2ZsSd.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-DlVONG8w.js";
import { i as listTasksForSessionKeyForStatus, r as listTasksForAgentIdForStatus, t as buildStatusReply } from "./commands-status-B8XqEDso.js";
import { i as buildNpmInstallRecordFields, n as persistPluginInstall } from "./plugins-install-persist-B9XPxLpW.js";
import { l as parseClawHubPluginSpec } from "./clawhub-B39GqI_T.js";
import { r as installPluginFromClawHub } from "./clawhub-BpjN6DLj.js";
import { a as buildPluginInspectReport, i as buildPluginDiagnosticsReport, o as buildPluginSnapshotReport, s as formatPluginCompatibilityNotice, t as buildAllPluginInspectReports } from "./status-C9YV9RW1.js";
import { a as decidePreferredClawHubFallback, f as resolveFileNpmSpecToLocalPath, i as createPluginInstallLogger, n as buildPreferredClawHubSpec } from "./plugins-command-helpers-CMdwpJTt.js";
import { n as loadCostUsageSummary, r as loadSessionCostSummary } from "./session-cost-usage-1zwG6IPd.js";
...
async function handleBashChatCommand(params) {
	...
	if (request.action === "stop") {
		...
		const { killProcessTree } = await import("./kill-tree-BNs_r4FO.js");
		killProcessTree(pid);
...
const handleCompactCommand = async (params) => {
	...
	const runtime = await import("./commands-compact.runtime-UCeAat-z.js");
	...
	const result = await runtime.compactEmbeddedPiSession({
		...
		sessionFile: runtime.resolveSessionFilePath(sessionId, params.sessionEntry, runtime.resolveSessionFilePathOptions({
			agentId: params.agentId,
			storePath: params.storePath
		})),
	...
	const totalTokens = result.result?.tokensAfter ?? runtime.resolveFreshSessionTotalTokens(params.sessionEntry);
	const contextSummary = runtime.formatContextUsageShort(typeof totalTokens === "number" && totalTokens > 0 ? totalTokens : null, params.contextTokens ?? params.sessionEntry.contextTokens ?? null);
...
async function buildContextReply(params) {
	const sub = normalizeLowercaseStringOrEmpty(parseContextArgs(params.command.commandBodyNormalized).split(/\s+/).filter(Boolean)[0]);
...
function loadAgentsAction() {
	actionAgentsPromise ??= import("./action-agents-BN0Vbh_s.js");
	return actionAgentsPromise;
}
function loadFocusAction() {
	actionFocusPromise ??= import("./action-focus-ieGxSypm.js");
	return actionFocusPromise;
}
function loadHelpAction() {
	actionHelpPromise ??= import("./action-help-coTzSAWq.js");
	return actionHelpPromise;
}
function loadInfoAction() {
	actionInfoPromise ??= import("./action-info-CDiwpTBc.js");
	return actionInfoPromise;
}
function loadKillAction() {
	actionKillPromise ??= import("./action-kill-BVtjHiCw.js");
	return actionKillPromise;
}
function loadListAction() {
	actionListPromise ??= import("./action-list-BP8kG0bF.js");
	return actionListPromise;
}
function loadLogAction() {
	actionLogPromise ??= import("./action-log-Cf_-Utpp.js");
	return actionLogPromise;
}
function loadSendAction() {
	actionSendPromise ??= import("./action-send-nk2HN2s5.js");
	return actionSendPromise;
}
function loadSpawnAction() {
	actionSpawnPromise ??= import("./action-spawn-QhIonzXn.js");
	return actionSpawnPromise;
}
function loadUnfocusAction() {
	actionUnfocusPromise ??= import("./action-unfocus-D8C-P15b.js");
	return actionUnfocusPromise;
}
function loadControlRuntime() {
	controlRuntimePromise ??= import("./commands-subagents-control.runtime-DtJ1M5Wb.js");
