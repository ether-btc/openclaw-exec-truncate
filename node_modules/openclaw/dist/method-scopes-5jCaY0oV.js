...
import { _ as GATEWAY_CLIENT_NAMES, g as GATEWAY_CLIENT_MODES, h as GATEWAY_CLIENT_IDS } from "./message-channel-BdU8JCBW.js";
...
import { n as ENV_SECRET_REF_ID_RE } from "./types.secrets-CWvOd-Rt.js";
import { n as FILE_SECRET_REF_ID_PATTERN, r as SECRET_PROVIDER_ALIAS_PATTERN, t as EXEC_SECRET_REF_ID_JSON_SCHEMA_PATTERN } from "./ref-contract-D3xgAKlC.js";
import { n as resolveReservedGatewayMethodScope } from "./gateway-method-policy-C5FE7M5s.js";
import { a as isLoopbackHost, c as isSecureWebSocketUrl } from "./net-DUdz9niH.js";
import { n as normalizeDeviceAuthScopes, t as normalizeDeviceAuthRole } from "./device-auth-BFC-UwRD.js";
import { t as safeParseJsonWithSchema } from "./zod-parse-DPAgk2k7.js";
import { a as signDevicePayload, i as publicKeyRawBase64UrlFromPem, n as loadOrCreateDeviceIdentity } from "./device-identity-DBalpSbl.js";
import { t as normalizeFingerprint } from "./fingerprint--aMCz2mV.js";
import { t as rawDataToString } from "./ws-D4Koe5EA.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-DiSCXVuY.js";
import { t as INPUT_PROVENANCE_KIND_VALUES } from "./input-provenance-PwI_R3ig.js";
import { n as MAX_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-afVpZOWo.js";
...
//#endregion
export { validateExecApprovalResolveParams as $, validateTalkSpeakParams as $t, validateConfigApplyParams as A, validateSessionsCompactionBranchParams as At, validateCronRemoveParams as B, validateSessionsPreviewParams as Bt, validateAgentsUpdateParams as C, validatePushTestParams as Ct, validateChatHistoryParams as D, validateSendParams as Dt, validateChatAbortParams as E, validateSecretsResolveResult as Et, validateConfigSchemaParams as F, validateSessionsDeleteParams as Ft, validateDevicePairApproveParams as G, validateSkillsBinsParams as Gt, validateCronRunsParams as H, validateSessionsResolveParams as Ht, validateConfigSetParams as I, validateSessionsListParams as It, validateDevicePairRemoveParams as J, validateSkillsSearchParams as Jt, validateDevicePairListParams as K, validateSkillsDetailParams as Kt, validateConnectParams as L, validateSessionsMessagesSubscribeParams as Lt, validateConfigPatchParams as M, validateSessionsCompactionListParams as Mt, validateConfigSchemaLookupParams as N, validateSessionsCompactionRestoreParams as Nt, validateChatInjectParams as O, validateSessionsAbortParams as Ot, validateConfigSchemaLookupResult as P, validateSessionsCreateParams as Pt, validateExecApprovalRequestParams as Q, validateTalkModeParams as Qt, validateCronAddParams as R, validateSessionsMessagesUnsubscribeParams as Rt, validateAgentsListParams as S, validatePollParams as St, validateChannelsStatusParams as T, validateSecretsResolveParams as Tt, validateCronStatusParams as U, validateSessionsSendParams as Ut, validateCronRunParams as V, validateSessionsResetParams as Vt, validateCronUpdateParams as W, validateSessionsUsageParams as Wt, validateDeviceTokenRotateParams as X, validateSkillsUpdateParams as Xt, validateDeviceTokenRevokeParams as Y, validateSkillsStatusParams as Yt, validateExecApprovalGetParams as Z, validateTalkConfigParams as Zt, validateAgentsCreateParams as _, buildDeviceAuthPayload as _n, validateNodePendingDrainParams as _t, resolveLeastPrivilegeOperatorScopesForMethod as a, validateWebLoginWaitParams as an, validateModelsListParams as at, validateAgentsFilesListParams as b, validatePluginApprovalRequestParams as bt, PAIRING_SCOPE as c, validateWizardStartParams as cn, validateNodeInvokeParams as ct, WRITE_SCOPE as d, errorShape as dn, validateNodePairApproveParams as dt, validateToolsCatalogParams as en, validateExecApprovalsGetParams as et, GatewayClient as f, parseSessionLabel as fn, validateNodePairListParams as ft, validateAgentWaitParams as g, getPreauthHandshakeTimeoutMsFromEnv as gn, validateNodePendingAckParams as gt, validateAgentParams as h, resolveDeviceAuthConnectErrorDetailCode as hn, validateNodePairVerifyParams as ht, isNodeRoleMethod as i, validateWebLoginStartParams as in, validateLogsTailParams as it, validateConfigGetParams as j, validateSessionsCompactionGetParams as jt, validateChatSendParams as k, validateSessionsCompactParams as kt, READ_SCOPE as l, validateWizardStatusParams as ln, validateNodeInvokeResultParams as lt, validateAgentIdentityParams as m, resolveAuthConnectErrorDetailCode as mn, validateNodePairRequestParams as mt, authorizeOperatorScopesForMethod as n, validateUpdateRunParams as nn, validateExecApprovalsNodeSetParams as nt, ADMIN_SCOPE as o, validateWizardCancelParams as on, validateNodeDescribeParams as ot, formatValidationErrors as p, ConnectErrorDetailCodes as pn, validateNodePairRejectParams as pt, validateDevicePairRejectParams as q, validateSkillsInstallParams as qt, isAdminOnlyMethod as r, validateWakeParams as rn, validateExecApprovalsSetParams as rt, APPROVALS_SCOPE as s, validateWizardNextParams as sn, validateNodeEventParams as st, CLI_DEFAULT_OPERATOR_SCOPES as t, validateToolsEffectiveParams as tn, validateExecApprovalsNodeGetParams as tt, TALK_SECRETS_SCOPE as u, ErrorCodes as un, validateNodeListParams as ut, validateAgentsDeleteParams as v, buildDeviceAuthPayloadV3 as vn, validateNodePendingEnqueueParams as vt, validateChannelsLogoutParams as w, validateRequestFrame as wt, validateAgentsFilesSetParams as x, validatePluginApprovalResolveParams as xt, validateAgentsFilesGetParams as y, validateNodeRenameParams as yt, validateCronListParams as z, validateSessionsPatchParams as zt };
