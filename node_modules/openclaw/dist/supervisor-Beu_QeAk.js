...
import { o as resolveWindowsCommandShim, s as spawnWithFallback } from "./exec-CgRcwTDe.js";
...
function createProcessSupervisor() {
	...
	const spawn = async (input) => {
		...
		try {
			...
			const { warnProcessSupervisorSpawnFailure } = await import("./supervisor-log.runtime-B7qMMoM-.js");
