...
import { f as readConfigFileSnapshot } from "./config-DMMR1XE_.js";
import { c as resolveGatewayLogPaths } from "./launchd-COgM_Pez.js";
import { a as inspectPortUsage, c as isDualStackLoopbackGatewayListeners, s as formatPortDiagnostics } from "./ports-Dj6_uq2y.js";
...
import { r as getRemoteSkillEligibility, t as canExecRequestNode } from "./exec-defaults-BxG8oO2K.js";
import { a as summarizeRestartSentinel, i as readRestartSentinel } from "./restart-sentinel-DLZSdB7O.js";
...
import { n as buildPluginCompatibilityNotices, s as formatPluginCompatibilityNotice } from "./status-C9YV9RW1.js";
...
import { n as resolveStatusAllConnectionDetails } from "./status.gateway-connection-CUc0i13z.js";
import { o as resolveStatusServiceSummaries, r as resolveStatusGatewayHealthSafe, u as buildStatusOverviewSurfaceFromOverview } from "./status-runtime-shared-6FuvM9i0.js";
import { a as buildStatusChannelsSection, c as buildStatusOverviewSection, f as buildStatusAllOverviewRows, i as buildStatusChannelDetailsSections, n as appendStatusSectionHeading, r as buildStatusAgentsSection, t as appendStatusReportSections } from "./text-report-CgJy-nXU.js";
import { t as resolveNodeOnlyGatewayInfo } from "./status.node-mode-CPqlhVZ5.js";
import { t as collectStatusScanOverview } from "./status.scan-overview-CyNXsEoO.js";
	...
	for (let i = 0; i < lines.length; i += 1) {
		...
		if (tokenRefresh) {
			...
			if (block) {
				...
				const msgShort = msg ? normalizeLowercaseStringOrEmpty(msg).includes("signing in again") ? "re-auth required" : shorten(msg, 52) : null;
