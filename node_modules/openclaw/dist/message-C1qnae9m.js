...
import { a as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-BwSfz6ox.js";
...
import { n as resolveOutboundChannelPlugin } from "./channel-resolution-DLfennyO.js";
...
function loadMessageConfigRuntime() {
	messageConfigRuntimePromise ??= import("./message.config.runtime-Bwa9MJXX.js");
	return messageConfigRuntimePromise;
}
function loadMessageGatewayRuntime() {
	messageGatewayRuntimePromise ??= import("./message.gateway.runtime-CJzyUxrc.js");
