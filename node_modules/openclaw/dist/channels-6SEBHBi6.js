...
import { D as isChannelVisibleInConfiguredLists } from "./message-channel-BdU8JCBW.js";
import { t as formatDocsLink } from "./links-_W1ZnMwp.js";
import { r as theme } from "./theme-DZuqFJmv.js";
import { i as loadAuthProfileStore } from "./store-DjuHA0jA.js";
...
import { t as danger } from "./globals-CuxBmXL5.js";
import { c as loadConfig, f as readConfigFileSnapshot, r as replaceConfigFile } from "./config-DMMR1XE_.js";
import { i as normalizeChannelId, r as listChannelPlugins, t as getChannelPlugin } from "./registry-CCo18B2d.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-mv9ZHZDG.js";
import "./plugins-b-MT-sRH.js";
import "./logging-Bzhr7ofr.js";
import { t as formatCliCommand } from "./command-format-Cf6Wzk70.js";
import { r as createMessageActionDiscoveryContext, s as resolveMessageActionDiscoveryForPlugin } from "./message-action-discovery-BmZPGxG5.js";
...
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-Cyq6oP-d.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-C1fKDuZP.js";
import { n as formatTimeAgo } from "./format-relative-DfTEpJOP.js";
import { n as hasResolvedCredentialValue, t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-D-tHJLCW.js";
...
import { n as formatUsageReportLines, t as loadProviderUsageSummary } from "./provider-usage-CFRwSPsv.js";
import { t as createClackPrompter } from "./clack-prompter-DSyarh4v.js";
import { r as listChannelPluginCatalogEntries } from "./catalog-DYTFQhzg.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-Cj6946LF.js";
import { t as parseLogLine } from "./parse-log-line-C7G-2ERM.js";
import { a as describeBinding, n as requireValidConfigSnapshot, r as applyAgentBindings, t as requireValidConfigFileSnapshot } from "./config-validation-C5t7PoOo.js";
import { a as isCatalogChannelInstalled, n as runCollectedChannelOnboardingPostWriteHooks, t as createChannelOnboardingPostWriteHookCollector } from "./onboard-channels-C5j_jJPs.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-BZQ3UbQB.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-KBaOB9w6.js";
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, { setupChannels }] = await Promise.all([import("./agents.config-B64YDZmt.js"), import("./onboard-channels-BqHkvmV5.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-CDN9id-x.js");
	...
	if (!channel && catalogEntry) {
		...
		if (!isCatalogChannelInstalled({
			...
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-CDN9id-x.js");
			const prompter = createClackPrompter();
