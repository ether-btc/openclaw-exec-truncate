import { i as formatUncaughtError, r as formatErrorMessage } from "./errors-CGMew-1w.js";
...
import { i as getChildLogger } from "./logger--Y4fLUmQ.js";
import { t as createNonExitingRuntime } from "./runtime-BXaxArxm.js";
import { t as createSubsystemLogger } from "./subsystem-CYqCtHnB.js";
import { f as resolveDefaultModelForAgent } from "./model-selection-ugeESflw.js";
import { _ as resolveStateDir } from "./paths-nQmEmngS.js";
import { _ as normalizeAccountId, d as resolveThreadSessionKeys, f as sanitizeAgentId, r as buildAgentMainSessionKey, u as resolveAgentIdFromSessionKey } from "./session-key-CJfa_Nnz.js";
import { a as resolveAgentDir, m as resolveDefaultAgentId } from "./agent-scope-CYaif3uh.js";
import { a as shouldLogVerbose, r as logVerbose, s as warn, t as danger } from "./globals-CuxBmXL5.js";
import { c as loadConfig, v as writeConfigFile } from "./config-DMMR1XE_.js";
import { v as getPluginCommandSpecs } from "./types-Bc6OypEK.js";
import { t as createDedupeCache } from "./dedupe-DdEu-Fo2.js";
import { n as createInternalHookEvent, p as triggerInternalHook } from "./internal-hooks-CyEt2RrF.js";
import { r as getRuntimeConfigSnapshot } from "./runtime-snapshot-BVfF9E0s.js";
import { a as resolveSessionStoreEntry, c as updateSessionStore } from "./store-CeqUIT7u.js";
import { l as resolveStorePath } from "./paths-iH379dx6.js";
import { t as loadSessionStore } from "./store-load-DF6H9tmN.js";
import { a as resolveNativeSkillsEnabled, i as resolveNativeCommandsEnabled, n as isNativeCommandsExplicitlyDisabled } from "./commands-B2SZ59iW.js";
import { a as modelSupportsVision, n as findModelInCatalog, r as loadModelCatalog } from "./model-catalog-xMydRuQF.js";
import { t as resolveAckReaction } from "./identity-D6Icj7ZP.js";
import { n as sleepWithAbort, t as computeBackoff } from "./backoff-CkqCU_Fp.js";
import { r as enqueueSystemEvent } from "./system-events-BWY8jYOz.js";
import { d as parseExecApprovalCommandText } from "./exec-approval-reply-GADShCh0.js";
import { p as resolveSendableOutboundReplyParts } from "./reply-payload-BRozqdR-.js";
import { c as resolveTextChunkLimit, s as resolveChunkMode } from "./chunk-SRc53mDN.js";
import { i as resolveChannelStreamingBlockEnabled } from "./channel-streaming-7LTCYldM.js";
import { f as fireAndForgetHook, i as toInternalMessageReceivedContext } from "./message-hook-mappers-D7GfHJlI.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-oI6a4kaI.js";
import { g as resolveChannelConfigWrites } from "./channel-config-helpers-C0sQcDUf.js";
import { c as stripReasoningTagsFromText, d as isInsideCode, u as findCodeRegions } from "./assistant-visible-text-NpNRTcmB.js";
import { t as MediaFetchError } from "./fetch-BgzO65-j.js";
import { t as loadWebMedia } from "./web-media-CQn3y5TB.js";
import { o as formatReasoningMessage } from "./pi-embedded-utils-D4tLgPAn.js";
import { i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-BP-6p4LO.js";
import { r as getSessionBindingService } from "./session-binding-service-BQQ2yli6.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-BRjvM9xb.js";
import { d as resolveThreadBindingSpawnPolicy, l as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel } from "./thread-bindings-policy-teIXk5UU.js";
import "./text-runtime-Y7jeuzOm.js";
import { n as resolveChannelGroupRequireMention, t as resolveChannelGroupPolicy } from "./group-policy-XJAXMNhx.js";
import "./core-D9kuUwWB.js";
import "./routing-D0K9urg9.js";
import { f as parsePluginBindingApprovalCustomId, i as buildPluginBindingResolvedText, m as resolvePluginConversationBindingApproval, u as isPluginOwnedSessionBindingRecord } from "./conversation-binding-CsWJgSK2.js";
import { d as listNativeCommandSpecsForConfig, g as resolveCommandArgMenu, m as parseCommandArgs, n as buildCommandTextFromArgs, p as normalizeCommandBody, r as findCommandByNativeName, u as listNativeCommandSpecs } from "./commands-registry-PfFcMtDz.js";
import { n as isAbortRequestText } from "./abort-primitives-C2k4EHCa.js";
import { t as hasControlCommand } from "./command-detection-DOqptL4k.js";
import { a as resolveEnvelopeFormatOptions, r as formatInboundEnvelope } from "./envelope-CEWh2RHV.js";
import { n as resolveInboundDebounceMs, t as createInboundDebouncer } from "./inbound-debounce-CLP1lWUs.js";
import { i as matchesMentionWithExplicit, n as buildMentionRegexes } from "./mentions-DOpiNSqS.js";
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./provider-dispatcher-COjV0JaB.js";
import { n as shouldAckReaction, t as removeAckReactionAfterReply } from "./ack-reactions-Bs_qVCey.js";
import { n as resolveControlCommandGate, t as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-D0wXR5VV.js";
import { n as resolveInboundMentionDecision, t as implicitMentionKindWhen } from "./mention-gating-D4a5mM9K.js";
import { t as resolveMarkdownTableMode } from "./markdown-tables-D17dZcew.js";
import { a as readChannelAllowFromStore, d as upsertChannelPairingRequest } from "./pairing-store-C6M42esc.js";
import { t as firstDefined } from "./allow-from-Bnt9nZBu.js";
import { a as buildPendingHistoryContextFromMap, s as clearHistoryEntriesIfEnabled, u as recordPendingHistoryEntryIfEnabled } from "./history-Bx4zUHxX.js";
import "./reply-history-CS-X6hAq.js";
import { n as logInboundDrop, r as logTypingFailure, t as logAckFailure } from "./logging-D4f9CB6p.js";
import { t as createChannelReplyPipeline } from "./channel-reply-pipeline-B9vwXaxt.js";
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-CoLYYHOY.js";
import "./runtime-env-FvdLNVj7.js";
import { t as resolveApprovalOverGateway } from "./approval-gateway-resolver-90m0SWao.js";
import "./approval-gateway-runtime-D09eWQra.js";
import { t as evaluateSupplementalContextVisibility } from "./context-visibility-BvRnDmCy.js";
import { t as resolveChannelContextVisibilityMode } from "./context-visibility-OspB3x-I.js";
import "./config-runtime-Cl-JrKQb.js";
import { t as resolveCommandAuthorization } from "./command-auth-Cynbg3ZA.js";
import { a as resolveStoredModelOverride } from "./model-selection-DYx7So9J.js";
import { n as isBtwRequestText } from "./btw-command-zohT5Oia.js";
import { t as generateConversationLabel } from "./reply-runtime-Bm_eA5lM.js";
import "./reply-dispatch-runtime-BklqOwc9.js";
import "./reply-chunking-CmqEAbEp.js";
import "./web-media-B4SISn9h.js";
import "./infra-runtime-DBGOsXVP.js";
import "./media-runtime-BHdp4EKl.js";
import { n as resolveConfiguredBindingRoute } from "./binding-routing-zNTxGkc9.js";
import "./conversation-runtime-DTqP40Bm.js";
import "./agent-runtime-DWgylha_.js";
import { a as createInteractiveConversationBindingHelpers, r as dispatchPluginInteractiveHandler } from "./plugin-runtime-Wce2LD4Z.js";
import "./security-runtime-CWZDnSsq.js";
import "./hook-runtime-BVCJEoP6.js";
import { n as formatModelsAvailableHeader, t as buildModelsProviderData } from "./commands-models-DiD7RCXo.js";
import "./markdown-table-runtime-CHoxOIVl.js";
import "./command-auth-CkXpYjY_.js";
import { t as resolveNativeCommandSessionTargets } from "./native-command-session-targets-C45VpMp9.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-ChboSFqX.js";
import { n as buildCommandsMessagePaginated } from "./status-CBY7BUi_.js";
import "./command-auth-native-Dq9926-A.js";
import "./command-detection-EvT_ZbjB.js";
import "./command-surface-Ds5W5x5a.js";
import "./error-runtime-OaZzlNpe.js";
import { n as DEFAULT_EMOJIS } from "./channel-feedback-_7K7DpX_.js";
import { n as shouldDebounceTextInbound } from "./channel-inbound-DeZjcIB1.js";
import { n as toLocationContext, t as formatLocationText } from "./location-u0mResm9.js";
import { i as createFinalizableDraftLifecycle } from "./channel-lifecycle-BdUpWVZ-.js";
import "./state-paths-ovWC-aLj.js";
import "./models-provider-runtime-CIPCRw5G.js";
import "./skill-commands-runtime-w_J4sE56.js";
import { c as resolveTelegramAccount, u as resolveTelegramMediaRuntimeOptions } from "./preview-streaming-Bx8pHtqz.js";
import { t as normalizeTelegramReplyToMessageId } from "./outbound-params-BMBus3xx.js";
import { r as resolveTelegramTransport } from "./fetch-BDuva35F.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-Dssp4-XE.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt, l as shouldEnableTelegramExecApprovalButtons, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-CMcKHX_O.js";
import { A as withResolvedTelegramForumFlag, B as isSenderAllowed, C as resolveTelegramDirectPeerId, E as resolveTelegramGroupAllowFromContext, F as getTelegramTextParts, H as normalizeDmAllowFromWithStore, I as hasBotMention, L as normalizeForwardedContext, M as buildSenderName, N as expandTextLinks, O as resolveTelegramStreamMode, P as extractTelegramLocation, S as extractTelegramForumFlag, T as resolveTelegramForumThreadId, U as resolveSenderAllowMatch, V as normalizeAllowFrom, _ as buildTelegramParentPeer, b as buildTypingThreadParams, c as isSafeToRetrySendError, g as buildTelegramGroupPeerId, h as buildTelegramGroupFrom, i as renderTelegramHtmlText, j as buildSenderLabel, k as resolveTelegramThreadSpec, l as isTelegramClientRejection, m as buildGroupLabel, p as tagTelegramNetworkError, s as isRecoverableTelegramNetworkError, v as buildTelegramRoutingTarget, w as resolveTelegramForumFlag, x as describeReplyTarget, y as buildTelegramThreadParams, z as resolveTelegramPrimaryMedia } from "./format-DXQQhQx2.js";
import { c as buildModelsKeyboard, d as getModelsPageSize, f as parseModelCallbackData, l as buildProviderKeyboard, p as resolveModelSelection, t as buildCommandsPaginationKeyboard, u as calculateTotalPages } from "./command-ui-CPtsvGF8.js";
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-CBNgNtSh.js";
import { t as createTelegramThreadBindingManager } from "./thread-bindings-DsyQE3qS.js";
import { n as describeStickerImage, t as cacheSticker } from "./sticker-cache-B0jX_u04.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-CGc9l5ik.js";
import { _ as wasSentByBot, a as editMessageTelegram, b as withTelegramApiErrorLogging, g as recordSentMessage, v as buildInlineKeyboard } from "./send-CaX1n35T.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-CxHauS7d.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-Dj5JGLop.js");
...
async function loadTelegramNativeCommandDeliveryRuntime() {
	telegramNativeCommandDeliveryRuntimePromise ??= import("./bot-native-commands.delivery.runtime-CR5BFZpT.js");
...
async function loadTelegramNativeCommandRuntime() {
	telegramNativeCommandRuntimePromise ??= import("./bot-native-commands.runtime-JhhKeqWe.js");
...
async function resolveStickerVisionSupport$1(params) {
	try {
		const { resolveStickerVisionSupportRuntime } = await import("./sticker-vision.runtime-5riRYxKz.js");
...
async function resolveTelegramInboundBody(params) {
	...
	if (hasAudio && !hasUserText && (!isGroup || requireMention && mentionRegexes.length > 0 && !disableAudioPreflight && senderAllowedForAudioPreflight)) try {
		const { transcribeFirstAudio } = await import("./media-understanding.runtime-DJ2URKfw.js");
...
async function buildTelegramInboundContextPayload(params) {
	...
	const sessionRuntime = await import("./bot-message-context.session.runtime-BDSL7tjo.js");
...
async function loadTelegramMessageContextRuntime() {
	telegramMessageContextRuntimePromise ??= import("./bot-message-context.runtime-ompv8ht4.js");
...
const createTelegramMessageProcessor = (deps) => {
	...
	return async (primaryCtx, allMedia, storeAllowFrom, options, replyMedia) => {
		...
		if (!context) {
			if (ingressDebugEnabled && ingressReceivedAtMs && ingressContextStartMs) logVerbose(`telegram ingress: chatId=${primaryCtx.message.chat.id} dropped after ${Date.now() - ingressReceivedAtMs}ms` + (options?.ingressBuffer ? ` buffer=${String(options.ingressBuffer)}` : ""));
			return;
		}
		if (ingressDebugEnabled && ingressReceivedAtMs && ingressContextStartMs) logVerbose(`telegram ingress: chatId=${context.chatId} contextReadyMs=${Date.now() - ingressReceivedAtMs} preDispatchMs=${Date.now() - ingressContextStartMs}` + (options?.ingressBuffer ? ` buffer=${String(options.ingressBuffer)}` : ""));
		try {
			...
			if (ingressDebugEnabled && ingressReceivedAtMs) logVerbose(`telegram ingress: chatId=${context.chatId} dispatchCompleteMs=${Date.now() - ingressReceivedAtMs}` + (options?.ingressBuffer ? ` buffer=${String(options.ingressBuffer)}` : ""));
		} catch (err) {
