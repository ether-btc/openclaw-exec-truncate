...
import { C as normalizeChannelId, S as normalizeAnyChannelId } from "./message-channel-BdU8JCBW.js";
import { _ as resolveRunModelFallbacksOverride } from "./agent-scope-CYaif3uh.js";
import { t as getChannelPlugin } from "./registry-CCo18B2d.js";
import "./plugins-b-MT-sRH.js";
import { l as isReasoningTagProvider } from "./content-blocks-ClNbDiTI.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo } from "./origin-routing-BrHwQ4il.js";
...
const resolveEnforceFinalTag = (run, provider, model = run.model) => Boolean((run.skipProviderRuntimeHints ? false : void 0) ?? (run.enforceFinalTag || isReasoningTagProvider(provider, {
	config: run.config,
