...
import { g as shouldPreferNativeJiti, h as resolvePluginSdkScopedAliasMap, m as resolvePluginSdkAliasFile, n as buildPluginLoaderJitiOptions } from "./sdk-alias-D2WzuNrI.js";
import { n as loadWebMediaRaw$1, o as getDefaultLocalRoots$1, r as optimizeImageToJpeg$1, t as loadWebMedia$1 } from "./web-media-CQn3y5TB.js";
...
function getLightExport(exportName) {
	...
	if (value == null) throw new Error(`web channel plugin runtime is missing export '${String(exportName)}'`);
	return value;
}
