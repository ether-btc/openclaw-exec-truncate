...
import { s as isPrivateOrLoopbackHost } from "./net-DUdz9niH.js";
import "./text-runtime-Y7jeuzOm.js";
import { O as promptAccountId, Q as splitSetupEntries, t as addWildcardAllowFrom, v as mergeAllowFromEntries } from "./setup-wizard-helpers-BSnJD8SD.js";
import { t as promptChannelAccessConfig } from "./setup-group-access-jb-mVWny.js";
import { i as hasLegacyFlatAllowPrivateNetworkAlias, o as isPrivateNetworkOptInEnabled, s as migrateLegacyFlatAllowPrivateNetworkAlias } from "./ssrf-policy-CQ1I3lt5.js";
import "./ssrf-runtime-ZcPQh_y3.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-C33jJt7P.js";
import { s as resolveMatrixAccountConfig, t as resolveMatrixConfigFieldPath } from "./config-paths-4bM15jMG.js";
import { l as resolveValidatedMatrixHomeserverUrl, s as resolveMatrixEnvAuthReadiness, u as validateMatrixHomeserverUrl } from "./config-BqOzcDau.js";
import "./env-auth-LA_hx7cb.js";
...
import { n as moveSingleMatrixAccountConfigToNamedAccount } from "./setup-core-e5SGM7pE.js";
import { t as updateMatrixAccountConfig } from "./config-update-CsedvUiI.js";
import "./client-DnHVnWNJ.js";
import { n as listMatrixDirectoryGroupsLive, t as resolveMatrixTargets } from "./resolve-targets-CBChD5hu.js";
import { n as ensureMatrixSdkInstalled, r as isMatrixSdkAvailable } from "./deps-BlRvJuQz.js";
...
async function configureMatrixInviteAutoJoin(params) {
	...
	while (true) {
		const allowlist = normalizeMatrixInviteAutoJoinTargets(splitSetupEntries(String(await params.prompter.text({
			...
			validate: (value) => {
				return splitSetupEntries(String(value ?? "")).length > 0 ? void 0 : "Required";
			}
		}))));
...
const matrixOnboardingAdapter = {
	...
	afterConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-BnwQ8azn.js");
