...
import { C as createEmptyPluginRegistry, d as recordImportedPluginId, i as getActivePluginRegistryKey, r as getActivePluginRegistry, s as getActivePluginRuntimeSubagentMode, y as setActivePluginRegistry } from "./runtime-D85K4f41.js";
import { i as openBoundaryFileSync, n as matchBoundaryFileOpenFailure } from "./boundary-file-read-D4i4p3X_.js";
...
import { i as kindsEqual, n as defaultSlotIdForKey, r as hasKind } from "./slots-CFrDTeTR.js";
import { t as isBlockedObjectKey } from "./prototype-keys-BWjW0VW8.js";
import { f as resolvePluginRuntimeModulePath, g as shouldPreferNativeJiti, n as buildPluginLoaderJitiOptions, t as buildPluginLoaderAliasMap } from "./sdk-alias-D2WzuNrI.js";
import { t as buildPluginApi } from "./api-builder-DR8O_7Wt.js";
import { a as normalizePluginsConfig, l as resolveMemorySlotDecision, n as createPluginActivationSource, o as resolveEffectiveEnableState, s as resolveEffectivePluginActivationState, t as applyTestPluginDefaults } from "./config-state-voeu0Fr5.js";
import { t as isChannelConfigured } from "./channel-configured-BOpIhLAy.js";
import { a as isPluginHookName, d as validatePluginCommandDefinition, f as normalizePluginInteractiveNamespace, g as clearPluginCommands, h as validatePluginInteractiveNamespace, l as registerPluginCommand, m as toPluginInteractiveRegistryKey, o as isPromptInjectionHookName, s as stripPromptMutationFieldsFromLegacyHookResult } from "./types-Bc6OypEK.js";
import { i as initializeGlobalHookRunner } from "./hook-runner-global-yij_VaUO.js";
import { n as resolveGlobalDedupeCache } from "./dedupe-DdEu-Fo2.js";
import { _ as restoreMemoryPluginState, a as getMemoryRuntime, c as listMemoryCorpusSupplements, d as registerMemoryCorpusSupplement, f as registerMemoryFlushPlanResolver, h as registerMemoryRuntime, i as getMemoryPromptSectionBuilder, l as listMemoryPromptSupplements, m as registerMemoryPromptSupplement, n as clearMemoryPluginState, p as registerMemoryPromptSection, r as getMemoryFlushPlanResolver, u as registerMemoryCapability } from "./memory-state-CeRc_0e1.js";
import { n as registerContextEngineForOwner } from "./registry-D4L8wbCo.js";
import { f as registerInternalHook } from "./internal-hooks-CyEt2RrF.js";
import { t as normalizePluginGatewayMethodScope } from "./gateway-method-policy-C5FE7M5s.js";
import { a as normalizePluginHttpPath, t as findOverlappingPluginHttpRoute } from "./http-route-overlap-COkJY7aQ.js";
...
function loadOpenClawPlugins(options = {}) {
	...
	try {
		...
		const resolveCreatePluginRuntime = () => {
			...
			const runtimeModule = getJiti(runtimeModulePath)(safeRuntimePath);
		...
		for (const candidate of orderedCandidates) {
			...
			try {
				...
				mod = getJiti(safeSource)(safeImportSource);
			} catch (err) {
				recordPluginError({
					logger,
					registry,
...
//#endregion
export { inspectBundleServerRuntimeSupport as C, applyMergePatch as E, loadEnabledBundleMcpConfig as S, readBundleJsonObject as T, listRegisteredMemoryEmbeddingProviders as _, resolveRuntimePluginRegistry as a, extractMcpServerMap as b, summarizeAllowedValues as c, NODE_BROWSER_PROXY_COMMAND as d, NODE_EXEC_APPROVALS_COMMANDS as f, listMemoryEmbeddingProviders as g, getRegisteredMemoryEmbeddingProvider as h, resolveCompatibleRuntimePluginRegistry as i, getPluginRuntimeGatewayRequestScope as l, NODE_SYSTEM_RUN_COMMANDS as m, loadOpenClawPluginCliRegistry as n, validateJsonSchemaValue as o, NODE_SYSTEM_NOTIFY_COMMAND as p, loadOpenClawPlugins as r, appendAllowedValuesHint as s, isPluginRegistryLoadInFlight as t, withPluginRuntimeGatewayRequestScope as u, registerMemoryEmbeddingProvider as v, loadEnabledBundleConfig as w, inspectBundleMcpRuntimeSupport as x, getCompactionProvider as y };
