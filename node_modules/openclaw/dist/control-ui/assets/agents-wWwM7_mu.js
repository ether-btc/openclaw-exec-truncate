import{f as e,o as t,r as n,u as r}from"./i18n-QqGuJlqQ.js";import{u as i}from"./format-DqeKy17V.js";import{t as a}from"./string-coerce-BfWUeqM-.js";import{A as o,C as s,D as c,O as l,S as u,T as d,_ as f,a as p,b as m,d as h,f as g,g as _,h as v,k as y,m as b,n as x,p as S,r as C,t as w,u as T,v as E,w as D,x as O,y as k}from"./index-6snfzTxc.js";import{r as A}from"./channel-config-extras-DnJU6jJq.js";import{i as j,n as M,r as N,t as P}from"./skills-shared-Di6eLLaS.js";function F(t){let{agent:i,configForm:a,agentFilesList:o,configLoading:s,configSaving:c,configDirty:l,onConfigReload:u,onConfigSave:d,onModelChange:p,onModelFallbacksChange:h,onSelectPanel:v}=t,y=E(a,i.id),b=i.model,x=(o&&o.agentId===i.id?o.workspace:null)||y.entry?.workspace||y.defaults?.workspace||i.workspace||`default`,S=y.entry?.model?m(y.entry?.model):y.defaults?.model?m(y.defaults?.model):m(b),C=m(y.defaults?.model??b),w=O(y.entry?.model),T=O(y.defaults?.model)||(C===`-`?null:_(C))||(a?null:O(b)),D=w??T??null,A=k(y.entry?.model)??k(y.defaults?.model)??(a?null:k(b))??[],j=Array.isArray(y.entry?.skills)?y.entry?.skills:null,M=j?.length??null,N=!!(t.defaultId&&i.id===t.defaultId),P=!a||s||c,F=e=>{let t=A.filter((t,n)=>n!==e);h(i.id,t)};return e`
    <section class="card">
        ...
        <div class="agent-model-fields">
          <label class="field">
            ...
            <select
              .value=${N?D??``:w??``}
              ?disabled=${P}
              @change=${e=>p(i.id,e.target.value||null)}
            >
          ...
          <div class="field">
            ...
            >
              ...
              <input
                ...
                @keydown=${e=>{let t=e.target;if(e.key===`Enter`||e.key===`,`){e.preventDefault();let n=f(t.value);n.length>0&&(h(i.id,[...A,...n]),t.value=``)}}}
                @blur=${e=>{let t=e.target,n=f(t.value);n.length>0&&(h(i.id,[...A,...n]),t.value=``)}}
              />
            </div>
          </div>
        </div>
...
${e}
      ...
      <section class="card">
        ...
        <div class="stat-grid" style="margin-top: 16px;">
          ...
          <div class="stat">
            ...
            <div class="stat-value">${p(t.status?.nextWakeAtMs??null)}</div>
          </div>
        </div>
        ${t.error?e`<div class="callout danger" style="margin-top: 12px;">${t.error}</div>`:r}
      </section>
  ...
  `}function me(t){let i=t.agentFilesList?.agentId===t.agentId?t.agentFilesList:null,a=i?.files??[],s=t.agentFileActive??null,u=s?a.find(e=>e.name===s)??null:null,d=s?t.agentFileContents[s]??``:``,f=s?t.agentFileDrafts[s]??d:``,p=s?f!==d:!1;return e`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
                      ...
                      <div class="md-preview-dialog__panel">
                        <div class="md-preview-dialog__header">
                          ...
                          <div class="md-preview-dialog__actions">
                            ...
                            >
                              <span class="when-normal">${y.maximize} Expand</span
                              ><span class="when-fullscreen">${y.minimize} Collapse</span>
                            </button>
                            <button
                              class="btn btn--sm"
                              title="Edit file"
                        ...
                        <div class="md-preview-dialog__body">
                          ${o(se(c.parse(f,{gfm:!0,breaks:!0}),{sanitize:e=>l.sanitize(e)}))}
                        </div>
                      </div>
                    </dialog>
  ...
  `}function ge(e){return e.source===`plugin`?e.pluginId?n(`agentTools.connectedSource`,{id:e.pluginId}):n(`agentTools.connected`):e.source===`channel`?e.channelId?n(`agentTools.channelSource`,{id:e.channelId}):n(`agentTools.channel`):n(`agentTools.builtIn`)}function _e(t){let i=E(t.configForm,t.agentId),a=i.entry?.tools??{},o=i.globalTools??{},c=a.profile??o.profile??`full`,l=s(t.toolsCatalogResult),f=D(t.toolsCatalogResult),p=a.profile?`agent override`:o.profile?`global default`:`default`,m=Array.isArray(a.allow)&&a.allow.length>0,h=Array.isArray(o.allow)&&o.allow.length>0,g=!!t.configForm&&!t.configLoading&&!t.configSaving&&!m&&!(t.toolsCatalogLoading&&!t.toolsCatalogResult&&!t.toolsCatalogError),_=m?[]:Array.isArray(a.alsoAllow)?a.alsoAllow:[],v=m?[]:Array.isArray(a.deny)?a.deny:[],y=m?{allow:a.allow??[],deny:a.deny??[]}:u(c)??void 0,x=f.flatMap(e=>e.tools.map(e=>e.id)),C=e=>{let t=S(e,y),n=b(e,_),r=b(e,v);return{allowed:(t||n)&&!r,baseAllowed:t,denied:r}},w=x.filter(e=>C(e).allowed).length,T=(e,n)=>{let r=new Set(_.map(e=>d(e)).filter(e=>e.length>0)),i=new Set(v.map(e=>d(e)).filter(e=>e.length>0)),a=C(e).baseAllowed,o=d(e);n?(i.delete(o),a||r.add(o)):(r.delete(o),i.add(o)),t.onOverridesChange(t.agentId,[...r],[...i])},O=e=>{let n=new Set(_.map(e=>d(e)).filter(e=>e.length>0)),r=new Set(v.map(e=>d(e)).filter(e=>e.length>0));for(let t of x){let i=C(t).baseAllowed,a=d(t);e?(r.delete(a),i||n.add(a)):(n.delete(a),r.add(a))}t.onOverridesChange(t.agentId,[...n],[...r])};return e`
    <section class="card">
                    ...
                    <div class="agent-tool-row">
                      ...
                      <label class="cfg-toggle">
                        <input
                          ...
                          .checked=${r}
                          ?disabled=${!g}
                          @change=${e=>T(n.id,e.target.checked)}
                        />
  ...
  `}function ve(t){let i=!!t.configForm&&!t.configLoading&&!t.configSaving,o=E(t.configForm,t.agentId),s=Array.isArray(o.entry?.skills)?o.entry?.skills:void 0,c=new Set((s??[]).map(e=>e.trim()).filter(Boolean)),l=s!==void 0,u=!!(t.report&&t.activeAgentId===t.agentId),d=u?t.report?.skills??[]:[],f=a(t.filter),p=f?d.filter(e=>a([e.name,e.description,e.source].join(` `)).includes(f)):d,m=j(p),h=l?d.filter(e=>c.has(e.name)).length:d.length,g=d.length;return e`
    <section class="card">
      <div class="row" style="justify-content: space-between; flex-wrap: wrap;">
        <div style="min-width: 0;">
      ...
      ${p.length===0?e` <div class="muted" style="margin-top: 16px">No skills found.</div> `:e`
            <div class="agent-skills-groups" style="margin-top: 16px;">
              ${m.map(e=>ye(e,{agentId:t.agentId,allowSet:c,usingAllowlist:l,editable:i,onToggle:t.onToggle}))}
            </div>
          `}
    </section>
    ...
    <div class="agents-layout">
      ...
      <section class="agents-main">
        ${s?e`
              ...
              ${t.activePanel===`channels`?pe({context:h(s,t.config.form,t.agentFiles.list,a,t.agentIdentityById[s.id]??null),configForm:t.config.form,snapshot:t.channels.snapshot,loading:t.channels.loading,error:t.channels.error,lastSuccess:t.channels.lastSuccess,onRefresh:t.onChannelsRefresh,onSelectPanel:t.onSelectPanel}):r}
              ${t.activePanel===`cron`?$({context:h(s,t.config.form,t.agentFiles.list,a,t.agentIdentityById[s.id]??null),agentId:s.id,jobs:t.cron.jobs,status:t.cron.status,loading:t.cron.loading,error:t.cron.error,onRefresh:t.onCronRefresh,onRunNow:t.onCronRunNow,onSelectPanel:t.onSelectPanel}):r}
            `:e`
              <div class="card">
...
//# sourceMappingURL=agents-wWwM7_mu.js.map