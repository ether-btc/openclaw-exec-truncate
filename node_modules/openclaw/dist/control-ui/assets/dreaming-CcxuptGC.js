import{f as e,r as t,u as n}from"./i18n-QqGuJlqQ.js";var r=/<!--\s*openclaw:dreaming:diary:start\s*-->/,i=/<!--\s*openclaw:dreaming:diary:end\s*-->/;function a(e){let t=e,n=r.exec(e),a=i.exec(e);n&&a&&a.index>n.index&&(t=e.slice(n.index+n[0].length,a.index));let o=[],s=t.split(/\n---\n/).filter(e=>e.trim().length>0);for(let e of s){let t=e.trim().split(`
...
//# sourceMappingURL=dreaming-CcxuptGC.js.map