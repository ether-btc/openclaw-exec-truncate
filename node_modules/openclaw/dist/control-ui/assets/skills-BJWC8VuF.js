import{f as e,r as t,u as n}from"./i18n-QqGuJlqQ.js";import{t as r}from"./format-DqeKy17V.js";import{t as i}from"./string-coerce-BfWUeqM-.js";import{E as a,j as o}from"./index-6snfzTxc.js";import{i as s,n as c,r as l,t as u}from"./skills-shared-Di6eLLaS.js";function d(e){return e?a(e,window.location.href):null}var f=[{id:`all`,label:`All`},{id:`ready`,label:`Ready`},{id:`needs-setup`,label:`Needs Setup`},{id:`disabled`,label:`Disabled`}];function p(e,t){switch(t){case`all`:return!0;case`ready`:return!e.disabled&&e.eligible;case`needs-setup`:return!e.disabled&&!e.eligible;case`disabled`:return e.disabled}}function m(e){return e.disabled?`muted`:e.eligible?`ok`:`warn`}function h(r){let a=r.report?.skills??[],o={all:a.length,ready:0,"needs-setup":0,disabled:0};for(let e of a)e.disabled?o.disabled++:e.eligible?o.ready++:o[`needs-setup`]++;let c=r.statusFilter===`all`?a:a.filter(e=>p(e,r.statusFilter)),l=i(r.filter),u=l?c.filter(e=>i([e.name,e.description,e.source].join(` `)).includes(l)):c,d=s(u),m=r.detailKey?a.find(e=>e.skillKey===r.detailKey)??null:null;return e`
    <section class="card">
...
//# sourceMappingURL=skills-BJWC8VuF.js.map