import { F as shouldMigrateStateFromPath } from "./logger--Y4fLUmQ.js";
...
async function ensureConfigReady(params) {
	...
	if (!didRunDoctorConfigFlow && shouldMigrateStateFromPath(commandPath)) {
		...
		const runDoctorConfigPreflight = async () => (await import("./doctor-config-preflight-CK8AwtSh.js")).runDoctorConfigPreflight({
			migrateState: false,
	...
	const { formatConfigIssueLines } = await import("./issue-format-Do9f_L3c.js");
	...
	const [{ colorize, isRich, theme }, { shortenHomePath }, { formatCliCommand }] = await Promise.all([
		import("./theme-CxKlmcm6.js"),
		import("./utils-ChjkJFgB.js"),
		import("./command-format-CynVh5ST.js")
	]);
	const rich = isRich();
