...
import { c as routeLogsToStderr } from "./subsystem-CYqCtHnB.js";
import { t as isTruthyEnvValue } from "./env-Bo5AGgpZ.js";
import { n as isGatewayConfigBypassCommandPath } from "./explicit-connection-policy-D1Jd-Ndo.js";
import { n as resolvePluginRegistryScopeForCommandPath, t as ensureCliPluginRegistryLoaded } from "./plugin-registry-loader-CnVMFy9p.js";
//#region src/cli/command-bootstrap.ts
let configGuardModulePromise;
function loadConfigGuardModule() {
	configGuardModulePromise ??= import("./config-guard-BN6EiLFP.js");
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-C4dyg8uB.js");
	if (params.argv) {
