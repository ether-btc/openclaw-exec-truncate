...
import { _ as normalizeAccountId, g as DEFAULT_ACCOUNT_ID } from "./session-key-CJfa_Nnz.js";
import { h as MarkdownConfigSchema, i as ContextVisibilityModeSchema, l as GroupPolicySchema } from "./zod-schema.core-DI4EkH6r.js";
import { i as buildNestedDmConfigSchema, r as buildChannelConfigSchema, t as AllowFromListSchema } from "./config-schema-CDNbtTnD.js";
import { o as ToolPolicySchema } from "./zod-schema.agent-runtime-157evrKY.js";
...
import { d as readNumberParam, h as readStringParam, i as createActionGate } from "./common-CynacdnN.js";
import { c as createScopedChannelConfigAdapter, t as adaptScopedAccountAccessor, u as createScopedDmSecurityResolver } from "./channel-config-helpers-C0sQcDUf.js";
import { i as createLazyRuntimeNamedExport } from "./lazy-runtime-CXfhfZLN.js";
import "./text-runtime-Y7jeuzOm.js";
import { n as formatPluginInstallPathIssue, t as detectPluginInstallPathIssue } from "./plugin-install-path-warnings-D9LuvxyQ.js";
import { t as removePluginFromConfig } from "./uninstall-BNbFQBvd.js";
import { n as describeAccountSnapshot } from "./account-helpers-Ch4tYU5h.js";
import { t as createScopedAccountReplyToModeResolver } from "./threading-helpers-D0wJPpWC.js";
import { r as createChatChannelPlugin, t as buildChannelOutboundSessionRoute } from "./core-D9kuUwWB.js";
import { r as buildSecretInputSchema } from "./secret-input-DuT2Jtet.js";
import "./channel-config-schema-BZEnnfuo.js";
import { C as projectAccountConfigWarningCollector, g as createAllowlistProviderOpenWarningCollector } from "./channel-policy-DM1sGttY.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-DHZnbzvs.js";
import { i as createResolvedDirectoryEntriesLister } from "./directory-config-helpers-AGliDmdz.js";
import { n as createRuntimeOutboundDelegates, t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-CkLb5CaK.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-DACoz9pC.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-CoLYYHOY.js";
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-6o_CyIi4.js";
import { t as extractToolSend } from "./tool-send-DE_EucOv.js";
import "./runtime-doctor-Bx1_M3Tb.js";
import "./config-runtime-Cl-JrKQb.js";
import "./outbound-runtime-HUYrqdL1.js";
import "./conversation-runtime-DTqP40Bm.js";
import { t as chunkTextForOutbound } from "./text-chunking-DtqzMHBS.js";
import { r as buildTrafficStatusSummary } from "./extension-shared-G0PtRsks.js";
import "./channel-config-primitives-8mYOdgTq.js";
import "./channel-core-CDq4u1RO.js";
import { t as zod_exports } from "./zod-CFM7KrIV.js";
import "./channel-status-BKE21ieU.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-C33jJt7P.js";
import { s as resolveMatrixAccountConfig } from "./config-paths-4bM15jMG.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-CQ8Kfy8l.js";
import "./runtime-api-BdEi9eYN.js";
import { l as shouldSuppressLocalMatrixExecApprovalPrompt, m as normalizeMatrixUserId, p as normalizeMatrixAllowList } from "./exec-approvals-C3ewEAdJ.js";
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-ft0y2S7G.js";
...
import { t as formatMatrixErrorMessage } from "./errors-CygnfMKT.js";
import { n as legacyConfigRules, r as normalizeCompatibilityConfig, t as matrixOnboardingAdapter } from "./setup-surface-DwejJyo0.js";
import { a as detectLegacyMatrixState, i as autoMigrateLegacyMatrixState, n as hasPendingMatrixMigration, o as autoPrepareLegacyMatrixCrypto, r as maybeCreateMatrixMigrationSnapshot, s as detectLegacyMatrixCrypto, t as hasActionableMatrixMigration } from "./runtime-heavy-api-BTXNUk1Z.js";
import "./matrix-migration.runtime-BFqHL-fd.js";
import { f as setMatrixThreadBindingMaxAgeBySessionKey, u as setMatrixThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings-shared-CjpSQlkZ.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-CsCjeJOa.js";
import { a as singleAccountKeysToMove, i as resolveSingleAccountPromotionTarget, r as namedAccountPromotionKeys, t as matrixSetupAdapter } from "./setup-core-e5SGM7pE.js";
...
const loadMatrixChannelRuntime$1 = createLazyRuntimeNamedExport(() => import("./channel.runtime-0buyP8NE.js"), "matrixChannelRuntime");
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-0buyP8NE.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-Bl-05QFP.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
