...
import { o as fetchWithRuntimeDispatcher } from "./fetch-guard-Dp23M272.js";
...
import { t as resolveRequestUrl } from "./request-url-DTjeB2cO.js";
...
import { i as createSlackWriteClient, r as createSlackWebClient } from "./client-2KZSMnck.js";
import { i as buildSlackBlocksFallbackText, t as sendMessageSlack } from "./send-D6-YDNCA.js";
...
function createSlackMediaFetch(token) {
	...
	return async (input, init) => {
		...
		const fetchImpl = "dispatcher" in (init ?? {}) && !isMockedFetch(globalThis.fetch) ? fetchWithRuntimeDispatcher : globalThis.fetch;
		if (includeAuth) {
			includeAuth = false;
