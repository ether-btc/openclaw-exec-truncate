...
import { n as info, o as success, t as danger } from "./globals-CuxBmXL5.js";
import { S as validateConfigObjectRaw, b as collectUnsupportedSecretRefPolicyIssues, f as readConfigFileSnapshot, r as replaceConfigFile } from "./config-DMMR1XE_.js";
import { d as resolveSecretInputRef, i as coerceSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-CWvOd-Rt.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-D3xgAKlC.js";
import { w as SecretProviderSchema } from "./zod-schema.core-DI4EkH6r.js";
import { a as resolveSecretRefValue } from "./resolve-CEgwP_Ay.js";
import { t as formatCliCommand } from "./command-format-Cf6Wzk70.js";
import { a as normalizeConfigIssues, n as formatConfigIssueLines } from "./issue-format-C8BtclgC.js";
import { c as resolveConfigSecretTargetByPath, n as discoverConfigSecretTargets } from "./target-registry-CBid13Yq.js";
import { i as redactConfigObject, n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-BF4emVC9.js";
import { n as setCommandJsonMode } from "./json-mode-Bqyvket_.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-DaHfvtSb.js");
