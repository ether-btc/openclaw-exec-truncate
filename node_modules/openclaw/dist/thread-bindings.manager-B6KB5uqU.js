...
import { _ as normalizeAccountId, u as resolveAgentIdFromSessionKey } from "./session-key-CJfa_Nnz.js";
import { r as logVerbose } from "./globals-CuxBmXL5.js";
import { r as getRuntimeConfigSnapshot } from "./runtime-snapshot-BVfF9E0s.js";
import { a as registerSessionBindingAdapter, o as unregisterSessionBindingAdapter } from "./session-binding-service-BQQ2yli6.js";
import { _ as resolveThreadBindingThreadName, h as resolveThreadBindingFarewellText } from "./thread-bindings-policy-teIXk5UU.js";
	...
	const manager = {
		...
		bindTarget: async (bindParams) => {
			...
			const record = {
				...
				targetKind,
				targetSessionKey,
				agentId: normalizeOptionalString(bindParams.agentId) ?? resolveAgentIdFromSessionKey(targetSessionKey),
