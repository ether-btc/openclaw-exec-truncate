...
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-Bpgg51GB.js";
import "./webhook-ingress-CIE_jq7u.js";
import "./error-runtime-OaZzlNpe.js";
import { t as zod_exports } from "./zod-CFM7KrIV.js";
import "./api-BmbuOgDj.js";
import { a as deepMergeDefined, i as validateProviderConfig, n as normalizeVoiceCallConfig, r as resolveVoiceCallConfig } from "./config-5Ryjhmv-.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-C2OGyicY.js";
import { a as convertPcmToMulaw8k, t as isProviderStatusTerminal } from "./call-status-BWTDbWWP.js";
import { t as getHeader } from "./http-headers-CL1giAXU.js";
...
var VoiceCallWebhookServer = class {
	...
	*/
	async initializeMediaStreaming() {
		...
		const { getRealtimeTranscriptionProvider, listRealtimeTranscriptionProviders } = await import("./realtime-transcription.runtime-NqQ0qOue.js");
  ...
  <Play loop="0">https://s3.amazonaws.com/com.twilio.music.classical/BusyStrings.mp3</Play>
	...
	*/
	async handleInboundResponse(callId, userMessage) {
		...
		try {
			const { generateVoiceResponse } = await import("./response-generator-C6u23F0E.js");
...
async function resolveProvider(config) {
	...
	switch (config.provider) {
		case "telnyx": {
			const { TelnyxProvider } = await import("./telnyx-BD4XY4az.js");
		...
		case "twilio": {
			const { TwilioProvider } = await import("./twilio-8qWwVeAe.js");
		...
		case "plivo": {
			const { PlivoProvider } = await import("./plivo-CHfA3FP4.js");
		...
		case "mock": {
			const { MockProvider } = await import("./mock-I4aLlsfZ.js");
...
async function resolveRealtimeProvider(params) {
	const { getRealtimeVoiceProvider, listRealtimeVoiceProviders } = await import("./realtime-voice.runtime-DurQpi7Y.js");
	const resolution = resolveConfiguredCapabilityProvider({
...
async function createVoiceCallRuntime(params) {
	...
	if (realtimeProvider) {
		const { RealtimeCallHandler } = await import("./realtime-handler-XzcGuskT.js");
