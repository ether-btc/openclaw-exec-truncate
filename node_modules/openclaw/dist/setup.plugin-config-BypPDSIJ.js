import { n as getPath, r as setPathCreateStrict } from "./path-utils-Bi2gu3mT.js";
...
async function promptPluginFields(params) {
	...
	for (const [key, hint] of Object.entries(plugin.uiHints)) {
		...
		if (trimmed !== currentStr) if (schemaProp?.type === "number") if (trimmed === "") {
...
async function setupPluginConfig(params) {
	const { loadPluginManifestRegistry } = await import("./manifest-registry-D-Fwvqhu.js");
