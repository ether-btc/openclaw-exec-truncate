...
import { o as getActivePluginRegistryWorkspaceDir, x as getActivePluginRegistryWorkspaceDirFromState } from "./runtime-D85K4f41.js";
import { l as isRecord, m as resolveUserPath, x as isPlainObject } from "./utils-Supr9KvU.js";
import { o as discoverOpenClawPlugins, r as normalizeChatChannelId, s as resolvePluginCacheInputs, t as CHANNEL_IDS } from "./ids-DQ8uU6i_.js";
import { t as createSubsystemLogger } from "./subsystem-CYqCtHnB.js";
import "./model-selection-ugeESflw.js";
import { r as normalizeProviderId } from "./provider-id-CAe4L4g9.js";
import { n as VERSION } from "./version-UAlvKBGq.js";
import { i as resolveManifestContractPluginIds, n as loadPluginManifestRegistry, r as resolveManifestContractOwnerPluginId } from "./manifest-registry-CNMsaTfa.js";
...
import { c as normalizeAgentId, g as DEFAULT_ACCOUNT_ID } from "./session-key-CJfa_Nnz.js";
import { t as isBlockedObjectKey } from "./prototype-keys-BWjW0VW8.js";
import { m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir } from "./agent-scope-CYaif3uh.js";
import { t as DEFAULT_CONTEXT_TOKENS } from "./defaults-BPcTA_Xa.js";
import { n as asNullableRecord } from "./record-coerce-Cmt1s1Tr.js";
import { g as shouldPreferNativeJiti, n as buildPluginLoaderJitiOptions, t as buildPluginLoaderAliasMap } from "./sdk-alias-D2WzuNrI.js";
import { t as isSafeExecutableValue } from "./exec-safety-CsUOjL_s.js";
import { i as coerceSecretRef } from "./types.secrets-CWvOd-Rt.js";
import { R as MODEL_APIS } from "./zod-schema.core-DI4EkH6r.js";
import { i as runPluginSetupConfigMigrations } from "./setup-registry-C-ujkY5_.js";
import { a as listBundledChannelPlugins } from "./bundled-BUZYiQLp.js";
import { r as listChannelPlugins } from "./registry-CCo18B2d.js";
import { d as resolveSingleAccountKeysToMove } from "./setup-helpers-mv9ZHZDG.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-FFyjNlfx.js";
import { t as withBundledPluginAllowlistCompat } from "./bundled-compat-DOAowBD7.js";
import { a as normalizePluginsConfig, l as resolveMemorySlotDecision, s as resolveEffectivePluginActivationState } from "./config-state-voeu0Fr5.js";
import { a as resolveDiscoveredProviderPluginIds, c as resolveOwningPluginIdsForProvider, i as resolveCatalogHookProviderPluginIds, l as withBundledProviderVitestCompat, o as resolveEnabledProviderPluginIds, r as resolveBundledProviderCompatPluginIds, s as resolveOwningPluginIdsForModelRefs, t as applyPluginAutoEnable } from "./plugin-auto-enable-A5w-taRF.js";
import { s as getBootstrapChannelPlugin } from "./channel-target-gAsvuN4R.js";
import { n as withActivatedPluginIds, t as resolveBundledPluginCompatibleActivationInputs } from "./activation-context-Cr2I59IT.js";
import { E as applyMergePatch, a as resolveRuntimePluginRegistry, c as summarizeAllowedValues, o as validateJsonSchemaValue, r as loadOpenClawPlugins, s as appendAllowedValuesHint, t as isPluginRegistryLoadInFlight } from "./loader-CVkGO8jl.js";
import { t as sanitizeTerminalText } from "./safe-text-DPlfbcYY.js";
import "./logging-Bzhr7ofr.js";
import { t as resolveProviderEndpoint } from "./provider-attribution-C_pj06zc.js";
import { i as normalizeEnvVarKey, n as isDangerousHostEnvOverrideVarName, r as isDangerousHostEnvVarName } from "./host-env-security-DdUy_DwF.js";
import { t as loadDotEnv } from "./dotenv-DQfz-m-5.js";
import { a as shouldDeferShellEnvFallback, i as resolveShellEnvFallbackTimeoutMs, o as shouldEnableShellEnvFallback, r as loadShellEnvFallback } from "./shell-env-DNQovkT9.js";
import { n as containsEnvVarReference, r as resolveConfigEnvVars } from "./env-substitution-CalzdAbi.js";
import { a as resolveConfigIncludes, i as readConfigIncludeFileWithGuards, n as ConfigIncludeError } from "./includes-BUJyNHi6.js";
import { i as normalizeTrustedSafeBinDirs, z as normalizeSafeBinProfileFixtures } from "./exec-safe-bin-trust-DOTK0AC_.js";
import { a as loadPinnedRuntimeConfig, i as getRuntimeConfigSourceSnapshot, n as finalizeRuntimeSnapshotWrite, o as notifyRuntimeConfigWriteListeners, r as getRuntimeConfigSnapshot, s as registerRuntimeConfigWriteListener } from "./runtime-snapshot-BVfF9E0s.js";
import { n as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-Bxdmtho1.js";
import { n as loadBundledChannelSecurityContractApi } from "./channel-contract-api-DHABLuw4.js";
import { c as isWindowsAbsolutePath, i as isAvatarHttpUrl, n as hasAvatarUriScheme, o as isPathWithinRoot, r as isAvatarDataUrl } from "./avatar-policy-CaS59ctA.js";
import { i as isCanonicalDottedDecimalIPv4, u as isLoopbackIpAddress } from "./ip-9u9YJphw.js";
import { t as OpenClawSchema } from "./zod-schema-LxGKAW20.js";
import { n as comparePrereleaseIdentifiers, r as normalizeLegacyDotBetaVersion } from "./semver-compare-BECLroGb.js";
...
function listChannelDoctorEntries(channelIds) {
	...
	for (const plugin of [...safeListActiveChannelPlugins(), ...safeListBundledChannelPlugins()]) {
		if (selectedIds && !selectedIds.has(plugin.id)) continue;
...
async function maybeRecoverSuspiciousConfigRead(params) {
	...
	const current = {
		...
		gatewayMode: resolveGatewayMode$1(params.parsed),
		observedAt: now
	};
...
function validateConfigObjectWithPluginsBase(raw, opts) {
	...
	for (const record of registry.plugins) {
		...
		const entryExists = entry !== void 0;
		const entryHasConfig = Boolean(entry?.config);
		const shouldReplacePluginConfig = opts.applyDefaults ? entryExists || entryHasConfig : entryHasConfig;
		...
		if (enabled || entryExists || entryHasConfig) if (record.configSchema) {
...
//#endregion
export { resolveProviderConfigApiKeyResolver as $, resolvePluginRuntimeLoadContext as $t, getConfigOverrides as A, resolveProviderDefaultThinkingLevel as At, findLegacyConfigIssues as B, resolveProviderUsageSnapshotWithPlugin as Bt, validateConfigObjectRawWithPlugins as C, resetProviderRuntimeHookCacheForTest as Ct, GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA as D, resolveProviderBuiltInModelSuppression as Dt, collectPluginSchemaMetadata as E, resolveProviderBinaryThinking as Et, parseConfigPath as F, resolveProviderStreamFn as Ft, normalizeGoogleApiBaseUrl as G, shouldDeferProviderSyntheticProfileAuthWithPlugin as Gt, createConfigRuntimeEnv as H, resolveProviderXHighThinking as Ht, setConfigValueAtPath as I, resolveProviderSyntheticAuthWithPlugin as It, resolveActiveTalkProviderConfig as J, wrapProviderStreamFn as Jt, buildTalkConfigResponse as K, shouldPreferProviderRuntimeResolvedModel as Kt, unsetConfigValueAtPath as L, resolveProviderSystemPromptContribution as Lt, setConfigOverride as M, resolveProviderReasoningOutputModeWithPlugin as Mt, unsetConfigOverride as N, resolveProviderReplayPolicyWithPlugin as Nt, resolveShellEnvExpectedKeys as O, resolveProviderCacheTtlEligibility as Ot, getConfigValueAtPath as P, resolveProviderRuntimePlugin as Pt, normalizeProviderSpecificConfig as Q, createPluginRuntimeLoaderLogger as Qt, asResolvedSourceConfig as R, resolveProviderTransportTurnStateWithPlugin as Rt, validateConfigObjectRaw as S, refreshProviderOAuthCredentialWithPlugin as St, collectChannelSchemaMetadata as T, resolveExternalOAuthProfilesWithPlugins as Tt, normalizeCompatibilityConfigValues as U, runProviderDynamicModel as Ut, collectDurableServiceEnvVars as V, resolveProviderWebSocketSessionPolicyWithPlugin as Vt, DEFAULT_GOOGLE_API_BASE_URL as W, sanitizeProviderReplayHistoryWithPlugin as Wt, resolveSubagentMaxConcurrent as X, buildPluginRuntimeLoadOptions as Xt, resolveAgentMaxConcurrent as Y, resolvePluginProviders as Yt, applyNativeStreamingUsageCompat as Z, buildPluginRuntimeLoadOptionsFromValues as Zt, resolveConfigSnapshotHash as _, normalizeProviderToolSchemasWithPlugin as _t, clearConfigCache as a, runChannelDoctorConfigSequences as an, buildProviderAuthDoctorHintWithPlugin as at, collectUnsupportedSecretRefPolicyIssues as b, prepareProviderExtraParams as bt, loadConfig as c, ensureControlUiAllowedOriginsForNonLoopbackBind as cn, classifyProviderFailoverReasonWithPlugin as ct, readBestEffortConfig as d, formatProviderAuthProfileApiKeyWithPlugin as dt, collectChannelDoctorEmptyAllowlistExtraWarnings as en, applyProviderConfigDefaultsWithPlugin as et, readConfigFileSnapshot as f, inspectProviderToolSchemasWithPlugin as ft, registerConfigWriteListener as g, normalizeProviderResolvedModelWithPlugin as gt, readSourceConfigSnapshotForWrite as h, normalizeProviderModelIdWithPlugin as ht, ConfigRuntimeRefreshError as i, collectChannelDoctorStaleConfigMutations as in, augmentModelCatalogWithProviderPlugins as it, resetConfigOverrides as j, resolveProviderModernModelRef as jt, applyConfigOverrides as k, resolveProviderConfigApiKeyWithPlugin as kt, parseConfigJson5 as l, listPluginDoctorLegacyConfigRules as ln, clearProviderRuntimeHookCache as lt, readSourceConfigSnapshot as m, normalizeProviderConfigWithPlugin as mt, mutateConfigFile as n, collectChannelDoctorPreviewWarnings as nn, applyProviderResolvedModelCompatWithPlugins as nt, createConfigIO as o, shouldSkipChannelDoctorDefaultEmptyGroupAllowlistWarning as on, buildProviderMissingAuthMessageWithPlugin as ot, readConfigFileSnapshotForWrite as p, matchesProviderContextOverflowWithPlugin as pt, normalizeTalkSection as q, validateProviderReplayTurnsWithPlugin as qt, replaceConfigFile as r, collectChannelDoctorRepairMutations as rn, applyProviderResolvedTransportWithPlugin as rt, getRuntimeConfig as s, applyLegacyDoctorMigrations as sn, buildProviderUnknownModelHintWithPlugin as st, ConfigMutationConflictError as t, collectChannelDoctorMutableAllowlistWarnings as tn, applyProviderNativeStreamingUsageCompatWithPlugin as tt, projectConfigOntoRuntimeSourceSnapshot as u, resolveOwnerDisplaySetting as un, createProviderEmbeddingProvider as ut, writeConfigFile as v, normalizeProviderTransportWithPlugin as vt, validateConfigObjectWithPlugins as w, resolveExternalAuthProfilesWithPlugins as wt, validateConfigObject as x, prepareProviderRuntimeAuth as xt, normalizeOpenClawVersionBase as y, prepareProviderDynamicModel as yt, asRuntimeConfig as z, resolveProviderUsageAuthWithPlugin as zt };
