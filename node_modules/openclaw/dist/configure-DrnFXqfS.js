...
import { Yt as resolvePluginProviders, c as loadConfig, f as readConfigFileSnapshot, r as replaceConfigFile } from "./config-DMMR1XE_.js";
import { o as isSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-CWvOd-Rt.js";
import { l as resolveDefaultSecretProviderAlias } from "./ref-contract-D3xgAKlC.js";
...
import { a as findTailscaleBinary } from "./tailscale-Cs7TvhCp.js";
import { t as resolveControlUiLinks } from "./control-ui-links-CZgAVvbF.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-Ba2G7Ut-.js";
import { a as guardCancel, c as normalizeGatewayTokenInput, d as randomToken, h as waitForGatewayReachable, m as validateGatewayPasswordInput, n as applyWizardMetadata, p as summarizeExistingConfig, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-CfSHbg7p.js";
import { n as isNonFatalSystemdInstallProbeError } from "./systemd-Clq-b867.js";
...
import { t as WizardCancelledError } from "./prompts-DWE4cpuB.js";
import { n as logConfigUpdated } from "./logging-BUckDeiV.js";
import { n as resolveProviderPluginChoice } from "./provider-wizard-CxrgbZXN.js";
...
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DFd7qKwJ.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-CEvtZYbN.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-DGVi8QHE.js";
import { n as applyAuthChoice } from "./auth-choice-Chqqt0JF.js";
import { i as noteChannelStatus, o as shouldShowChannelInSetup, r as setupChannels } from "./onboard-channels-C5j_jJPs.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-yAvoElJW.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-De1_tEoM.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-3E8FhDmD.js";
import { i as promptCustomApiConfig } from "./onboard-custom-OwQ9y0j7.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-DlW1eipX.js";
import { t as formatHealthCheckFailure } from "./health-format-DCzJNGfN.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-msc-ZfgW.js";
import { t as setupSkills } from "./onboard-skills-D67ES7j9.js";
...
async function promptGatewayConfig(cfg, runtime) {
	...
	if (authMode === "trusted-proxy") {
		...
		const requiredHeaders = requiredHeadersRaw ? normalizeStringEntries(String(requiredHeadersRaw).split(",")) : [];
		...
		const allowUsers = allowUsersRaw ? normalizeStringEntries(String(allowUsersRaw).split(",")) : [];
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-DZypaNS1.js");
	const { describeCodexNativeWebSearch, isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-C0IzqALP.js");
...
async function runConfigureWizard(opts, runtime = defaultRuntime) {
	try {
		...
		const configureWorkspace = async () => {
			...
			workspaceDir = resolveUserPath(normalizeOptionalString(String(workspaceInput ?? "")) || DEFAULT_WORKSPACE);
			if (!snapshot.exists) {
				const indicators = [
					"MEMORY.md",
					"memory",
		...
		if (opts.sections) {
			...
			if (selected.includes("plugins")) {
				const { configurePluginConfig } = await import("./setup.plugin-config-BypPDSIJ.js");
