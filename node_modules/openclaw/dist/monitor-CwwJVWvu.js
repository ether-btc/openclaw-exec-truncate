...
import { a as resolveSenderScopedGroupPolicy, t as evaluateGroupRouteAccessForPolicy } from "./group-access-83qr-4oC.js";
import { o as resolveDmGroupAccessWithLists, t as DM_GROUP_ACCESS_REASON } from "./dm-policy-shared-CXuIpNws.js";
...
import { n as resolveSenderCommandAuthorization } from "./command-auth-CkXpYjY_.js";
import { a as createDeferred } from "./extension-shared-G0PtRsks.js";
import "./channel-inbound-DeZjcIB1.js";
import { c as isZalouserGroupEntryAllowed, i as resolveZalouserMessageSid, o as buildZalouserGroupCandidates, r as formatZalouserMessageSidFull, s as findZalouserGroupEntry, t as getZalouserRuntime } from "./runtime-CvEuzFws.js";
import { o as listZaloGroups, r as listZaloFriends, u as resolveZaloGroupContext, v as startZaloListener } from "./zalo-js-M3zkh34J.js";
import { i as sendMessageZalouser, o as sendSeenZalouser, s as sendTypingZalouser, t as sendDeliveredZalouser } from "./send-DOpd4aSv.js";
...
function resolveUserAllowlistEntries(entries, byName) {
	...
	for (const entry of entries) {
		...
		const match = (byName.get(normalizeLowercaseStringOrEmpty(entry)) ?? [])[0];
	...
	try {
		...
		if (groupKeys.length > 0) {
			...
			for (const entry of groupKeys) {
				...
				const match = (byName.get(normalizeLowercaseStringOrEmpty(cleaned)) ?? [])[0];
