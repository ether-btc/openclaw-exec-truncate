...
import { t as require_src } from "./src-BwGIwPxA.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-Cq-zjiOG.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-CmnawX3C.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-CGGndbh6.js";
import { l as toRatio, n as decodeString } from "./Util-Ddxi_Mmh.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-B_AWkGmH.js";
import { t as APEv2Parser } from "./APEv2Parser-Cvk2udud.js";
import { r as hasID3v1Header } from "./ID3v1Parser-INnDy3NE.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-DqVzVMP3.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-XLp9nTsB.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-DgdPw3Mi.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-B6vR2GsG.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-CUj0ID9R.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-CwVL75GX.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-BrKdaOgd.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-Bn3BVS0t.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-CQvYV5st.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-BD8Znocr.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-Dy6t6ntf.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-01s5sivc.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-DANI0nXB.js")).WaveParser;
	}
};
//#endregion
