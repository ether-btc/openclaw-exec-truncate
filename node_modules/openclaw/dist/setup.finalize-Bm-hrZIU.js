...
import { r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-Q6iYWMyk.js";
import { n as resolveCliName } from "./cli-name-BWB8p-dr.js";
...
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-nYv3FQHN.js";
import { h as waitForGatewayReachable, i as formatControlUiSshHint, u as probeGatewayReachable } from "./onboard-helpers-CfSHbg7p.js";
import { i as isSystemdUserServiceAvailable } from "./systemd-Clq-b867.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-CkFSPlvH.js";
import { n as listConfiguredWebSearchProviders } from "./runtime-BSKy4RNb.js";
...
import { t as runTui } from "./tui-D5qAoi-a.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-DCAABl42.js");
	...
	const { describeCodexNativeWebSearch } = await import("./codex-native-web-search-C0IzqALP.js");
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-DZypaNS1.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-DZypaNS1.js");
