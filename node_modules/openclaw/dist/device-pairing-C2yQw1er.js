...
import { n as normalizeDeviceAuthScopes } from "./device-auth-BFC-UwRD.js";
import { a as resolvePairingPaths, i as reconcilePendingPairingRequests, n as verifyPairingToken, o as resolveMissingRequestedScope, r as pruneExpiredPending, s as roleScopesAllow, t as generatePairingToken } from "./pairing-token-B-q5GfJ-.js";
import { t as rejectPendingPairingRequest } from "./pairing-pending-C1aMzKoU.js";
import { r as resolveBootstrapProfileScopesForRole } from "./device-bootstrap-profile-DrSHh-OQ.js";
...
async function approveDevicePairing(requestId, optionsOrBaseDir, maybeBaseDir) {
	...
	return await withLock(async () => {
		...
		if (requestedOperatorScopes.length > 0) {
			...
			if (!requestedRoles.includes(OPERATOR_ROLE)) return {
				status: "forbidden",
...
//#endregion
export { hasEffectivePairedDeviceRole as a, listEffectivePairedDeviceRoles as c, requestDevicePairing as d, revokeDeviceToken as f, verifyDeviceToken as g, updatePairedDeviceMetadata as h, getPairedDevice as i, rejectDevicePairing as l, summarizeDeviceTokens as m, approveDevicePairing as n, listApprovedPairedDeviceRoles as o, rotateDeviceToken as p, ensureDeviceToken as r, listDevicePairing as s, approveBootstrapDevicePairing as t, removePairedDevice as u };
