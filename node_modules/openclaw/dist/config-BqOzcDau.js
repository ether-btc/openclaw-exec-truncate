...
import { _ as normalizeAccountId, g as DEFAULT_ACCOUNT_ID, v as normalizeOptionalAccountId } from "./session-key-CJfa_Nnz.js";
import { c as normalizeResolvedSecretInputString, i as coerceSecretRef } from "./types.secrets-CWvOd-Rt.js";
import "./text-runtime-Y7jeuzOm.js";
import { n as retryAsync } from "./retry-BiAixub_.js";
import "./secret-input-DuT2Jtet.js";
import { o as isPrivateNetworkOptInEnabled, t as assertHttpUrlTargetsPrivateNetwork, u as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-CQ1I3lt5.js";
...
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-C33jJt7P.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-i7Db9_5U.js";
import { c as resolveMatrixBaseConfig, i as findMatrixAccountConfig, o as listNormalizedMatrixAccountIds, t as resolveMatrixConfigFieldPath } from "./config-paths-4bM15jMG.js";
import { t as getMatrixRuntime } from "./runtime-CUrFkdnS.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-Ija_m7Ej.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-DcOJIyyL.js"), import("./logging-CVVgyrG5.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-BQt6pu60.js").then((credentialsReadModule) => ({
...
async function loadMatrixSecretInputDeps() {
	matrixSecretInputDepsPromise ??= import("./config-secret-input.runtime-Dfymswvk.js").then((runtime) => ({ resolveConfiguredSecretInputString: runtime.resolveConfiguredSecretInputString }));
...
async function resolveMatrixAuth(params) {
	...
	const loadCredentialsWriter = async () => {
		credentialsWriter ??= await import("./credentials-write.runtime-t50qAew8.js");
...
async function backfillMatrixAuthDeviceIdAfterStartup(params) {
	...
	if (isAbortSignalTriggered(params.abortSignal)) return;
	return await (await import("./credentials-write.runtime-t50qAew8.js")).saveBackfilledMatrixDeviceId({
		homeserver: params.auth.homeserver,
		userId: params.auth.userId,
		accessToken: params.auth.accessToken,
		deviceId
