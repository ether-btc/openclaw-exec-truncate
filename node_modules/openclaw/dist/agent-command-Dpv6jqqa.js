...
import { a as isGatewayMessageChannel, d as normalizeMessageChannel, o as isInternalMessageChannel, p as resolveMessageChannel, r as isDeliverableMessageChannel, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-BdU8JCBW.js";
...
import "./auth-profiles-D2m7aC_t.js";
import { c as normalizeThinkLevel, n as formatXHighModelHint, u as normalizeVerboseLevel } from "./thinking.shared-CqTfMucU.js";
import { C as modelKey, T as parseModelRef, d as resolveConfiguredModelRef, f as resolveDefaultModelForAgent, s as isCliProvider, t as buildAllowedModelSet, w as normalizeModelRef, x as resolveThinkingDefault } from "./model-selection-ugeESflw.js";
import { c as normalizeAgentId, u as resolveAgentIdFromSessionKey } from "./session-key-CJfa_Nnz.js";
import { a as resolveAgentDir, f as resolveAgentSkillsFilter, h as resolveEffectiveModelFallbacks, p as resolveAgentWorkspaceDir, r as listAgentIds, v as resolveSessionAgentId, x as matchesSkillFilter } from "./agent-scope-CYaif3uh.js";
...
import { c as loadConfig, p as readConfigFileSnapshotForWrite } from "./config-DMMR1XE_.js";
import { i as normalizeChannelId, t as getChannelPlugin } from "./registry-CCo18B2d.js";
import "./plugins-b-MT-sRH.js";
import { l as setRuntimeConfigSnapshot } from "./runtime-snapshot-BVfF9E0s.js";
...
import { n as mergeSessionEntry, o as setSessionRuntimeModel } from "./types-rNu4VxRu.js";
import { c as normalizeAccountId } from "./delivery-context-DG5DsDyV.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-czMcFzei.js";
import { r as resolveSessionTranscriptFile } from "./transcript-61cUaMiH.js";
import { r as loadModelCatalog } from "./model-catalog-xMydRuQF.js";
import { Q as AGENT_LANE_SUBAGENT, Z as AGENT_LANE_NESTED, et as formatAgentInternalEventsForPrompt, i as resolveSession, nt as runWithModelFallback, r as prepareSessionManagerForRun, rt as LiveSessionModelSwitchError, t as runEmbeddedPiAgent } from "./pi-embedded-CNTNdlGw.js";
import { n as resolveContextTokensForModel } from "./context-CIaFOK75.js";
import { a as resolveModelCostConfig, n as estimateUsageCost } from "./usage-format-CgDWHf4_.js";
import { c as hasNonzeroUsage, s as deriveSessionTotalTokens } from "./chat-envelope-CwV6pYqA.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText } from "./tokens-CgHHhFXy.js";
import { o as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-cquxQ6fH.js";
import { j as hasInternalRuntimeContext } from "./errors-DEuzndId.js";
import { i as supportsXHighThinking, t as formatThinkingLevels } from "./thinking-D0jPPsk8.js";
import { i as normalizeOutboundPayloadsForJson, n as formatOutboundPayloadLog, r as normalizeOutboundPayloads, t as deliverOutboundPayloads } from "./deliver-BwSfz6ox.js";
import { S as shouldRefreshSnapshotForVersion, r as getRemoteSkillEligibility, t as canExecRequestNode, y as getSkillsSnapshotVersion } from "./exec-defaults-BxG8oO2K.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-BVkCmI1q.js";
import { t as buildOutboundSessionContext } from "./session-context-CHdPn-1E.js";
import { i as resolveSessionDeliveryTarget, r as resolveOutboundTarget } from "./targets-DRk_sn6S.js";
import { t as FailoverError } from "./failover-error-BOJISXS1.js";
import { t as getAgentRuntimeCommandSecretTargetIds } from "./command-secret-targets-Cyq6oP-d.js";
import { i as emitAgentEvent, t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-D0ACUj3I.js";
import { t as normalizeReplyPayload } from "./normalize-reply-BRACnYgb.js";
...
import { i as toAcpRuntimeError } from "./errors-DASGJrYh.js";
import { n as getAcpSessionManager } from "./manager-Cv_GZCdX.js";
import { s as normalizeSpawnedRunMetadata } from "./captured-registration-Cdk430eW.js";
import { n as resolveAcpAgentPolicyError, r as resolveAcpDispatchPolicyError } from "./policy-6zBTSZPU.js";
import { t as resolveAcpSessionCwd } from "./session-identifiers-qkbF5HDz.js";
import { r as buildWorkspaceSkillSnapshot } from "./skills-ChGZGQ52.js";
import { n as resolveSendPolicy } from "./send-policy-BQqNSKxy.js";
import { t as createReplyPrefixContext } from "./reply-prefix-CW9yADu2.js";
import { t as clearSessionAuthProfileOverride } from "./session-override-DFKhjfzi.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-3EqfVz2e.js";
import { t as createDefaultDeps } from "./deps-BRGfolRH.js";
import { t as applyVerboseOverride } from "./level-overrides-D3zZ4sh1.js";
import { a as setCliSessionBinding, n as clearCliSession, o as setCliSessionId, r as getCliSessionBinding, t as runCliAgent } from "./cli-runner-CucgBOHg.js";
import { t as createOutboundSendDeps } from "./outbound-send-deps-J5RPpvw0.js";
...
async function prepareAgentCommandExecution(opts, runtime) {
	...
	const isSubagentLane = (normalizeOptionalString(opts.lane) ?? "") === String(AGENT_LANE_SUBAGENT);
