...
import { m as resolveDefaultAgentId } from "./agent-scope-CYaif3uh.js";
...
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-DhXzxYnn.js";
import { t as buildAgentSessionKey } from "./resolve-route-BP-6p4LO.js";
import "./text-runtime-Y7jeuzOm.js";
import { r as withManager } from "./cli-utils-CZ-ZI1rg.js";
import "./routing-D0K9urg9.js";
import "./memory-core-host-runtime-core-BmPg_6MJ.js";
import { n as withProgress, r as withProgressTotals } from "./progress-DqzSI7Zj.js";
import "./memory-core-host-runtime-cli-CozHbO3M.js";
import { V as resolveMemoryRemDreamingConfig } from "./dreaming-58cRx0K5.js";
import "./memory-core-host-status-BFwMDzAx.js";
import { c as listMemoryFiles, l as normalizeExtraMemoryPaths } from "./internal-DtqOhyRA.js";
import "./memory-core-host-runtime-files-BNZOekJ_.js";
import { a as readShortTermRecallEntries, c as repairShortTermPromotionArtifacts, i as rankShortTermPromotionCandidates, l as resolveShortTermRecallLockPath, n as applyShortTermPromotions, r as auditShortTermPromotionArtifacts, s as recordShortTermRecalls, u as resolveShortTermRecallStorePath } from "./short-term-promotion-CF110O8c.js";
import "./dreaming-shared-BzcKRN-h.js";
import { n as resolveShortTermPromotionDreamingConfig, r as previewRemDreaming } from "./dreaming-looUjKfS.js";
import { n as getMemorySearchManager } from "./memory-Drw32IYW.js";
...
function matchesPromotionSelector(candidate, selector) {
	...
	return normalizeLowercaseStringOrEmpty(candidate.key) === trimmed || normalizeLowercaseStringOrEmpty(candidate.key).includes(trimmed) || normalizeLowercaseStringOrEmpty(candidate.path).includes(trimmed) || normalizeLowercaseStringOrEmpty(candidate.snippet).includes(trimmed);
}
...
async function runMemoryPromoteExplain(selectorArg, opts) {
	...
	await withMemoryManagerForAgent({
		...
		run: async (manager) => {
			...
			const rich = isRich();
			const lines = [
				`${colorize(rich, theme.heading, "Promotion Explain")} ${colorize(rich, theme.muted, "(" + String(agentId) + ")")}`,
