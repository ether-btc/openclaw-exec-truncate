...
import { m as requireActivePluginChannelRegistry, n as getActivePluginChannelRegistryVersion } from "./runtime-D85K4f41.js";
import { n as normalizeAtHashSlug, s as normalizeStringEntries } from "./string-normalization-IdjIlZzV.js";
import { n as CHAT_CHANNEL_ORDER } from "./ids-DQ8uU6i_.js";
import { S as normalizeAnyChannelId, d as normalizeMessageChannel, f as resolveGatewayMessageChannel, o as isInternalMessageChannel, r as isDeliverableMessageChannel } from "./message-channel-BdU8JCBW.js";
...
import { m as resolveModelRefFromString } from "./model-selection-ugeESflw.js";
import { c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey, w as parseAgentSessionKey } from "./session-key-CJfa_Nnz.js";
import { a as resolveAgentDir, f as resolveAgentSkillsFilter, i as resolveAgentConfig, n as listAgentEntries, p as resolveAgentWorkspaceDir, v as resolveSessionAgentId } from "./agent-scope-CYaif3uh.js";
import { r as logVerbose } from "./globals-CuxBmXL5.js";
import { d as ensureAgentWorkspace, n as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-Q6iYWMyk.js";
import "./defaults-BPcTA_Xa.js";
import { c as loadConfig } from "./config-DMMR1XE_.js";
import { t as getBundledChannelPlugin } from "./bundled-BUZYiQLp.js";
import { i as normalizeChannelId, n as getLoadedChannelPlugin, r as listChannelPlugins, t as getChannelPlugin } from "./registry-CCo18B2d.js";
import { E as applyMergePatch } from "./loader-CVkGO8jl.js";
import "./plugins-b-MT-sRH.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-yij_VaUO.js";
import { n as createInternalHookEvent, p as triggerInternalHook } from "./internal-hooks-CyEt2RrF.js";
import { _ as resolveGroupSessionKey, a as resolveSessionStoreEntry, c as updateSessionStore, m as deriveSessionMetaPatch } from "./store-CeqUIT7u.js";
import { t as normalizeChatType } from "./chat-type-CQ9r5rAj.js";
import { t as canonicalizeMainSessionAlias } from "./main-session-DaD0xK0B.js";
import { a as resolveSessionTranscriptPath, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-iH379dx6.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-rNu4VxRu.js";
import { a as resolveThreadFlag, i as resolveSessionResetType, n as resolveChannelResetConfig, r as resolveSessionResetPolicy, t as evaluateSessionFreshness } from "./reset-ClbjyzZk.js";
import { n as resolveSessionKey } from "./session-key-i2poQWVq.js";
import { a as normalizeDeliveryContext, n as deliveryContextKey, o as normalizeSessionDeliveryFields, t as deliveryContextFromSession } from "./delivery-context-DG5DsDyV.js";
import { t as loadSessionStore } from "./store-load-DF6H9tmN.js";
import { t as resolveAndPersistSessionFile } from "./session-file-Bqa5WMrx.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-CgHHhFXy.js";
import { i as generateSecureToken } from "./secure-random-Dso58VT9.js";
import { o as getQueueSize, r as clearCommandLane } from "./command-queue-BjuwOmis.js";
import { i as disposeSessionMcpRuntime, l as isReasoningTagProvider, t as collectTextContentBlocks } from "./content-blocks-ClNbDiTI.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-Cri_haGY.js";
import { n as applyOwnerOnlyToolPolicy } from "./tool-policy-dLQuqjVi.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-BJzbQ0Dl.js";
import { i as supportsXHighThinking } from "./thinking-D0jPPsk8.js";
import { r as enqueueSystemEvent } from "./system-events-BWY8jYOz.js";
import { f as fireAndForgetHook, n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-D7GfHJlI.js";
import { t as buildOutboundSessionContext } from "./session-context-CHdPn-1E.js";
import { t as resolveQueueSettings } from "./queue-C2eYTgDP.js";
import { r as getSessionBindingService } from "./session-binding-service-BQQ2yli6.js";
import { t as resolveAgentTimeoutMs } from "./timeout-DwUOu7ws.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-XJAXMNhx.js";
import { p as normalizeCommandBody } from "./commands-registry-PfFcMtDz.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-C2k4EHCa.js";
import { t as hasControlCommand } from "./command-detection-DOqptL4k.js";
import { t as resolveRunTypingPolicy } from "./typing-policy-BzxixY41.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-CkfVTefB.js";
import { t as finalizeInboundContext } from "./inbound-context-Bq2CmFVy.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-CEWh2RHV.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-DOpiNSqS.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-2jyTWbL7.js";
import { t as resolveChannelModelOverride } from "./model-overrides-2Wl-WfiQ.js";
import { t as normalizeGroupActivation } from "./group-activation-gRLuYTMk.js";
import { n as parseInlineDirectives, t as isDirectiveOnly } from "./directive-handling.parse-7AYaQ01A.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-Bk7QrNLQ.js";
import { t as resolveFastModeState } from "./fast-mode-D6W9Pa_w.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-BlHwKPvB.js";
import { t as resolveCommandAuthorization } from "./command-auth-Cynbg3ZA.js";
import { t as buildCommandContext } from "./commands-context-ByKhLI8J.js";
...
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-DYx7So9J.js";
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-pbtPU2WL.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-CHna38P9.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-BrHwQ4il.js";
import { n as resolveTypingMode, r as resolveActiveRunQueueAction } from "./typing-mode-BIpRZ9gh.js";
import { t as buildBareSessionResetPrompt } from "./session-reset-prompt-DFLiekQA.js";
import { t as drainFormattedSystemEvents } from "./session-system-events-DwBlbhV_.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-9bPFHOkV.js";
import { n as buildSessionStartHookPayload, t as buildSessionEndHookPayload } from "./session-hooks-DfQuSSN7.js";
...
function loadCommandsStatus() {
	commandsStatusPromise ??= import("./commands-status.runtime-bol59Cl-.js");
	return commandsStatusPromise;
}
function loadDirectiveLevels() {
	directiveLevelsPromise ??= import("./directive-handling.levels-C8oGHm8M.js");
	return directiveLevelsPromise;
}
function loadDirectiveImpl() {
	directiveImplPromise ??= import("./directive-handling.impl-BKlFQipp.js");
	return directiveImplPromise;
}
function loadDirectiveFastLane() {
	directiveFastLanePromise ??= import("./directive-handling.fast-lane-CEwH8qMW.js");
	return directiveFastLanePromise;
}
function loadDirectivePersist() {
	directivePersistPromise ??= import("./directive-handling.persist.runtime-DsG4uCwt.js");
...
function loadGroupsRuntime() {
	groupsRuntimePromise ??= import("./groups.runtime-DK5ny1mh.js");
...
function resolveAllowFromFormatter(params) {
	...
	return (values) => formatAllowFrom({
		...
		allowFrom: values
	}).map((entry) => normalizeOptionalString(String(entry)) ?? "").filter(Boolean);
}
...
function loadCommandsRegistry() {
	commandsRegistryPromise ??= import("./commands-registry.runtime-lVDqsDyn.js");
	return commandsRegistryPromise;
}
function loadSkillCommands() {
	skillCommandsPromise ??= import("./skill-commands.runtime-thjymIZx.js");
...
async function resolveReplyDirectives(params) {
	...
	const modelState = useFastReplyRuntime && !directives.hasModelDirective && !hasResolvedHeartbeatModelOverride && !normalizeOptionalString(sessionEntry?.modelOverride) && !normalizeOptionalString(sessionEntry?.providerOverride) ? createFastTestModelSelectionState({
		agentCfg,
		provider,
		model
...
async function handleInlineActions(params) {
	...
	const skillCommands = shouldLoadSkillCommands && params.skillCommands ? params.skillCommands : shouldLoadSkillCommands ? (await import("./skill-commands.runtime-thjymIZx.js")).listSkillCommandsForWorkspace({
		workspaceDir,
		cfg,
		agentId,
		skillFilter
	...
	if (skillInvocation) {
		...
		if (dispatch?.kind === "tool") {
			...
			const { createOpenClawTools } = await import("./openclaw-tools.runtime-CVXAigM4.js");
	...
	if (!isAbortRequestText(command.rawBodyNormalized) && sessionEntry) {
		...
		if (cutoff) await (await import("./abort-cutoff.runtime-B4bvMYmz.js")).clearAbortCutoffInSessionRuntime({
			sessionEntry,
			sessionStore,
			sessionKey,
			storePath
	...
	if (handleInlineStatus) {
		const { buildStatusReply } = await import("./commands.runtime-DWpBf_Zp.js");
	...
	const runCommands = async (commandInput) => {
		const { handleCommands } = await import("./commands.runtime-DWpBf_Zp.js");
...
function loadSessionStoreRuntime$1() {
	sessionStoreRuntimePromise$1 ??= import("./store.runtime-BUcpw0Z0.js");
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded.runtime-CHkR7aUt.js");
	return piEmbeddedRuntimePromise;
}
function loadAgentRunnerRuntime() {
	agentRunnerRuntimePromise ??= import("./agent-runner.runtime-BEglkhP6.js");
	return agentRunnerRuntimePromise;
}
function loadSessionUpdatesRuntime() {
	sessionUpdatesRuntimePromise ??= import("./session-updates.runtime-Hgpa-VWl.js");
	return sessionUpdatesRuntimePromise;
}
function loadSessionStoreRuntime() {
	sessionStoreRuntimePromise ??= import("./store.runtime-BUcpw0Z0.js");
...
function loadDeliverRuntime() {
	deliverRuntimePromise ??= import("./deliver-runtime-CPKZJDaD.js");
...
async function forkSessionFromParent(params) {
	return (await import("./session-fork.runtime-z31C-gyJ.js")).forkSessionFromParentRuntime(params);
}
//#endregion
...
function loadSessionArchiveRuntime() {
	sessionArchiveRuntimePromise ??= import("./session-archive.runtime-K88iIsM_.js");
...
function loadSessionResetModelRuntime() {
	sessionResetModelRuntimePromise ??= import("./session-reset-model.runtime-D0xmoTyQ.js");
	return sessionResetModelRuntimePromise;
}
function loadStageSandboxMediaRuntime() {
	stageSandboxMediaRuntimePromise ??= import("./stage-sandbox-media.runtime-C4A67AkQ.js");
...
function loadHookRunnerGlobal() {
	hookRunnerGlobalPromise ??= import("./hook-runner-global-BMMfeHYj.js");
	return hookRunnerGlobalPromise;
}
function loadOriginRouting() {
	originRoutingPromise ??= import("./origin-routing-D5C4uFBb.js");
...
async function applyMediaUnderstandingIfNeeded(params) {
	...
	const { applyMediaUnderstanding } = await import("./apply.runtime-Dxc_viMe.js");
	await applyMediaUnderstanding(params);
	return true;
}
async function applyLinkUnderstandingIfNeeded(params) {
	if (!hasLinkCandidate(params.ctx)) return false;
	const { applyLinkUnderstanding } = await import("./apply.runtime-pAfQibzM.js");
...
async function getReplyFromConfig(ctx, opts, configOverride) {
	...
	const maybeEmitMissingResetHooks = async () => {
		...
		const { emitResetCommandHooks } = await import("./commands-core.runtime-Df4Kay9r.js");
