...
import { f as readConfigFileSnapshot, v as writeConfigFile } from "./config-DMMR1XE_.js";
...
async function resolveAuthChoiceModelSelectionPolicy(params) {
	...
	const { resolvePluginProviders, resolveProviderPluginChoice } = await import("./provider-auth-choice.runtime-CLpU0u8D.js");
...
async function runSetupWizard(opts, runtime = defaultRuntime, prompter) {
	const onboardHelpers = await import("./onboard-helpers-DauffMTZ.js");
	...
	if (mode === "remote") {
		const { promptRemoteGatewayConfig } = await import("./onboard-remote-CSrHiTtZ.js");
		const { logConfigUpdated } = await import("./logging-CTMy0xlG.js");
	...
	const { applyLocalSetupWorkspaceConfig } = await import("./onboard-config-qfgWKuN-.js");
	let nextConfig = applyLocalSetupWorkspaceConfig(baseConfig, workspaceDir);
	const { ensureAuthProfileStore } = await import("./agents/auth-profiles.runtime.js");
	const { promptAuthChoiceGrouped } = await import("./auth-choice-prompt-8WY0ktyL.js");
	const { promptCustomApiConfig } = await import("./onboard-custom-Cx3jAk87.js");
	const { applyAuthChoice, resolvePreferredProviderForAuthChoice, warnIfModelConfigLooksOff } = await import("./auth-choice-BfYj55St.js");
	const { applyPrimaryModel, promptDefaultModel } = await import("./model-picker-tzNVlbl-.js");
	...
	const { configureGatewayForSetup } = await import("./setup.gateway-config-BZlnEbgz.js");
	...
	if (opts.skipChannels ?? opts.skipProviders) await prompter.note("Skipping channel setup.", "Channels");
		...
		const { listChannelPlugins } = await import("./plugins-CHdWE64I.js");
		const { setupChannels } = await import("./onboard-channels-BqHkvmV5.js");
	...
	if (opts.skipSearch) await prompter.note("Skipping search setup.", "Search");
		...
		const { setupSearch } = await import("./onboard-search-DZypaNS1.js");
	...
	if (opts.skipSkills) await prompter.note("Skipping skills setup.", "Skills");
		...
		const { setupSkills } = await import("./onboard-skills-Q2FqCHGp.js");
		nextConfig = await setupSkills(nextConfig, workspaceDir, runtime, prompter);
	}
	if (flow !== "quickstart") {
		const { setupPluginConfig } = await import("./setup.plugin-config-BypPDSIJ.js");
	...
	const { setupInternalHooks } = await import("./onboard-hooks-DGTSCj6g.js");
	...
	await writeConfigFile(nextConfig);
	const { finalizeSetupWizard } = await import("./setup.finalize-Bm-hrZIU.js");
