...
import { l as buildStatusOverviewRowsFromSurface } from "./status-runtime-shared-6FuvM9i0.js";
...
function buildStatusPluginCompatibilityValue(params) {
	...
	const pluginCount = new Set(params.notices.map((notice) => String(notice.pluginId ?? notice.plugin ?? ""))).size;
