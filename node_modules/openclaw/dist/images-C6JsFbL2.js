...
import { u as listDeliverableMessageChannels } from "./message-channel-BdU8JCBW.js";
import { c as normalizeAgentId, o as classifySessionKeyShape, w as parseAgentSessionKey } from "./session-key-CJfa_Nnz.js";
...
import { t as buildMemoryPromptSection } from "./memory-state-CeRc_0e1.js";
import { t as redactIdentifier } from "./redact-identifier-DYAmMWEE.js";
import { n as normalizeStructuredPromptSection, t as normalizePromptCapabilityIds } from "./prompt-cache-stability-BHzlc6Gt.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-CgHHhFXy.js";
import { n as buildBootstrapInjectionStats } from "./bootstrap-budget-cquxQ6fH.js";
import { n as sanitizeImageBlocks } from "./tool-images-DemYfIs0.js";
import { i as resolveUserTimezone, r as resolveUserTimeFormat, t as formatUserTime } from "./date-time-D0lBhCyH.js";
import { i as safeFileURLToPath, t as assertNoWindowsNetworkPath } from "./local-file-access-WqgNjq-K.js";
import { n as assertSandboxPath } from "./sandbox-paths-CvEDn46r.js";
import { c as resolveMediaBufferPath, s as getMediaDir } from "./store-6Eiv7dYr.js";
import { t as loadWebMedia } from "./web-media-CQn3y5TB.js";
import { t as SYSTEM_PROMPT_CACHE_BOUNDARY } from "./system-prompt-cache-boundary-DwoRj1ZG.js";
import { t as log } from "./logger-JNS26Ome.js";
import { t as findGitRoot } from "./git-root-XZgHC6CE.js";
...
function buildProjectContextSection(params) {
	...
	for (const file of params.files) lines.push(`## ${file.path}`, "", file.content, "");
	return lines;
}
...
function buildAgentSystemPrompt(params) {
	...
	const inlineButtonsEnabled = new Set(runtimeCapabilities.map((cap) => normalizeLowercaseStringOrEmpty(String(cap))).filter(Boolean)).has("inlinebuttons");
...
//#endregion
export { buildSystemPromptParams as a, buildAgentSystemPrompt as c, createSandboxBridgeReadFile as d, resolveSandboxedBridgeMediaPath as f, buildSystemPromptReport as i, wrapUntrustedPromptDataBlock as l, detectImageReferences as n, redactRunIdentifier as o, loadImageFromRef as r, resolveRunWorkspaceDir as s, detectAndLoadPromptImages as t, resolveSystemPromptOverride as u };
